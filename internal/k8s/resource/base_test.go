...
func TestCopyHelpers_Nil(t *testing.T) {
	...
	if CopySlice[[]string](nil) != nil {
		t.Error("CopySlice(nil) != nil")
	}
	if CopySliceInto[nested](nil) != nil {
		t.Error("CopySliceInto(nil) != nil")
	}
	if CopyMap[map[string]string](nil) != nil {
		t.Error("CopyMap(nil) != nil")
	}
	if CopyPtrFunc[int](nil, nil) != nil {
		t.Error("CopyPtrFunc(nil) != nil")
	}
}
