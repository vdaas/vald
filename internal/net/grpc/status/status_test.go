...
// 			}
//
// 			got := Is(test.args.err, test.args.code)
// 			if err := checkFunc(test.want, got); err != nil {
// 				tt.Errorf("error = %v", err)
// 			}
// 		})
...
// 		afterFunc  func(*testing.T, args)
// 	}
// 	defaultCheckFunc := func(w want, gotSt *Status) error {
// 		if !reflect.DeepEqual(gotSt, w.wantSt) {
// 			return errors.Errorf("got: \"%#v\",\n\t\t\t\twant: \"%#v\"", gotSt, w.wantSt)
// 		}
// 		return nil
...
// }
//
// func TestCreateWithNotFound(t *testing.T) {
// 	type args struct {
// 		msg     string
// 		err     error
// 		details []any
...
// 			}
//
// 			got := CreateWithNotFound(test.args.msg, test.args.err, test.args.details...)
// 			if err := checkFunc(test.want, got); err != nil {
// 				tt.Errorf("error = %v", err)
// 			}
// 		})
...
// 		args
// 		want
// 		checkFunc  func(want, *Status, bool) error
// 		beforeFunc func(*testing.T, args)
// 		afterFunc  func(*testing.T, args)
// 	}
// 	defaultCheckFunc := func(w want, gotSt *Status, gotOk bool) error {
// 		if !reflect.DeepEqual(gotSt, w.wantSt) {
// 			return errors.Errorf("got: \"%#v\",\n\t\t\t\twant: \"%#v\"", gotSt, w.wantSt)
// 		}
...
// }
//
// func Test_mergeBadRequest(t *testing.T) {
// 	type args struct {
// 		ds      []proto.Message
...
// 		args
// 		want
// 		checkFunc  func(want, *errdetails.BadRequest) error
// 		beforeFunc func(*testing.T, args)
// 		afterFunc  func(*testing.T, args)
// 	}
// 	defaultCheckFunc := func(w want, got *errdetails.BadRequest) error {
// 		if !reflect.DeepEqual(got, w.want) {
// 			return errors.Errorf("got: \"%#v\",\n\t\t\t\twant: \"%#v\"", got, w.want)
// 		}
// 		return nil
...
// 			}
//
// 			got := mergeBadRequest(test.args.ds, test.args.visited)
// 			if err := checkFunc(test.want, got); err != nil {
// 				tt.Errorf("error = %v", err)
// 			}
// 		})
...
// }
//
// func Test_mergePreconditionFailure(t *testing.T) {
// 	type args struct {
// 		ds      []proto.Message
// 		visited map[string]bool
// 	}
// 	type want struct {
// 		want *errdetails.PreconditionFailure
// 	}
// 	type test struct {
// 		name       string
// 		args
// 		want
// 		checkFunc  func(want, *errdetails.PreconditionFailure) error
// 		beforeFunc func(*testing.T, args)
// 		afterFunc  func(*testing.T, args)
// 	}
// 	defaultCheckFunc := func(w want, got *errdetails.PreconditionFailure) error {
// 		if !reflect.DeepEqual(got, w.want) {
// 			return errors.Errorf("got: \"%#v\",\n\t\t\t\twant: \"%#v\"", got, w.want)
// 		}
// 		return nil
...
// 			}
//
// 			got := mergePreconditionFailure(test.args.ds, test.args.visited)
// 			if err := checkFunc(test.want, got); err != nil {
// 				tt.Errorf("error = %v", err)
// 			}
// 		})
