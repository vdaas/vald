...
func (g *gRPCClient) Connect(
	...
	res, _, err := g.group.Do(ctx, "connect-"+addr, func(ctx context.Context) (any, error) {
...
func (g *gRPCClient) Disconnect(ctx context.Context, addr string) error {
	...
	_, _, err := g.group.Do(ctx, "disconnect-"+addr, func(ctx context.Context) (any, error) {
