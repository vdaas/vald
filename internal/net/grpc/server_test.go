...
// 			}
//
// 			got := MaxConcurrentStreams(test.args.n)
// 			if err := checkFunc(test.want, got); err != nil {
// 				tt.Errorf("error = %v", err)
// 			}
// 		})
...
// }
//
// func TestNumStreamWorkers(t *testing.T) {
// 	type args struct {
// 		n uint32
// 	}
// 	type want struct {
...
// 			}
//
// 			got := NumStreamWorkers(test.args.n)
// 			if err := checkFunc(test.want, got); err != nil {
// 				tt.Errorf("error = %v", err)
// 			}
// 		})
...
// 			}
//
// 			got := SharedWriteBuffer(test.args.val)
// 			if err := checkFunc(test.want, got); err != nil {
// 				tt.Errorf("error = %v", err)
// 			}
// 		})
...
// 			}
//
// 			got := WaitForHandlers(test.args.val)
// 			if err := checkFunc(test.want, got); err != nil {
// 				tt.Errorf("error = %v", err)
// 			}
// 		})
