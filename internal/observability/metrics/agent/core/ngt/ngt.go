...
func (n *ngtMetrics) Measurement(ctx context.Context) ([]metrics.Measurement, error) {
	...
	return []metrics.Measurement{
		...
		n.uncommittedIndexCount.M(int64(n.ngt.InsertVQueueLen() + n.ngt.DeleteVQueueLen())),
		n.insertVQueueCount.M(int64(n.ngt.InsertVQueueLen())),
		n.deleteVQueueCount.M(int64(n.ngt.DeleteVQueueLen())),
