...
func Test_tx_RollbackUnlessCommitted(t *testing.T) {
	t.Parallel()
	type fields struct {
		Tx *dbr.Tx
	}
...
func Test_tx_InsertBySql(t *testing.T) {
	t.Parallel()
	type args struct {
		query string
		value []interface{}
...
func Test_tx_InsertInto(t *testing.T) {
	t.Parallel()
	type args struct {
		table string
	}
...
func Test_tx_DeleteFrom(t *testing.T) {
	t.Parallel()
	type args struct {
		table string
	}
