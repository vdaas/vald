...
func TestWithClusterSlots(t *testing.T) {
	type T = redisClient
	type args struct {
		f func(context.Context) ([]redis.ClusterSlot, error)
	}
	type want struct {
		obj *T
		err error
...
func TestWithOnConnectFunction(t *testing.T) {
	type T = redisClient
	type args struct {
		f func(ctx context.Context, conn *redis.Conn) error
	}
	type want struct {
		obj *T
		err error
...
// 			}
//
// 			got := WithUsername(test.args.name)
// 			if err := checkFunc(test.want, got); err != nil {
// 				tt.Errorf("error = %v", err)
// 			}
//
...
// }
//
// func TestWithSentinelMasterName(t *testing.T) {
// 	type args struct {
// 		name string
// 	}
// 	type want struct {
...
// 			}
//
// 			got := WithSentinelMasterName(test.args.name)
// 			if err := checkFunc(test.want, got); err != nil {
// 				tt.Errorf("error = %v", err)
// 			}
//
...
// }
//
// func TestWithSentinelPassword(t *testing.T) {
// 	type args struct {
// 		password string
// 	}
// 	type want struct {
...
// 			}
//
// 			got := WithSentinelPassword(test.args.password)
// 			if err := checkFunc(test.want, got); err != nil {
// 				tt.Errorf("error = %v", err)
// 			}
//
...
// 			}
//
// 			got := WithLimiter(test.args.limiter)
// 			if err := checkFunc(test.want, got); err != nil {
// 				tt.Errorf("error = %v", err)
// 			}
//
