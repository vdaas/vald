...
func Test_gatewayClient_Exists(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if !reflect.DeepEqual(got, tt.want) {
				t.Errorf("gatewayClient.Exists() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func Test_gatewayClient_Search(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if !reflect.DeepEqual(got, tt.want) {
				t.Errorf("gatewayClient.Search() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func Test_gatewayClient_SearchByID(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if !reflect.DeepEqual(got, tt.want) {
				t.Errorf("gatewayClient.SearchByID() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func Test_gatewayClient_MultiUpsert(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if err := tt.c.MultiUpsert(tt.args.ctx, tt.args.req); (err != nil) != tt.wantErr {
...
func Test_gatewayClient_StreamUpsert(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if err := tt.c.StreamUpsert(tt.args.ctx, tt.args.dataProvider, tt.args.f); (err != nil) != tt.wantErr {
...
func Test_gatewayClient_GetObject(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if !reflect.DeepEqual(got, tt.want) {
				t.Errorf("gatewayClient.GetObject() = %v, want %v", got, tt.want)
			}
		})
	}
}
