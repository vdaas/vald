...
func Test_client_StreamSearch(t *testing.T) {
	...
	type want struct {
		wantRes vald.Vald_StreamSearchClient
		err     error
	}
	type test struct {
		name       string
	...
	defaultCheckFunc := func(w want, gotRes vald.Vald_StreamSearchClient, err error) error {
		if !errors.Is(err, w.err) {
			return errors.Errorf("got_error: \"%#v\",\n\t\t\t\twant: \"%#v\"", err, w.err)
		}
		if !reflect.DeepEqual(gotRes, w.wantRes) {
...
func Test_client_StreamSearchByID(t *testing.T) {
	...
	type want struct {
		wantRes vald.Vald_StreamSearchByIDClient
		err     error
	}
	type test struct {
		name       string
	...
	defaultCheckFunc := func(w want, gotRes vald.Vald_StreamSearchByIDClient, err error) error {
		if !errors.Is(err, w.err) {
			return errors.Errorf("got_error: \"%#v\",\n\t\t\t\twant: \"%#v\"", err, w.err)
		}
		if !reflect.DeepEqual(gotRes, w.wantRes) {
...
func Test_client_StreamInsert(t *testing.T) {
	...
	type want struct {
		wantRes vald.Vald_StreamInsertClient
		err     error
	}
	type test struct {
		name       string
	...
	defaultCheckFunc := func(w want, gotRes vald.Vald_StreamInsertClient, err error) error {
		if !errors.Is(err, w.err) {
			return errors.Errorf("got_error: \"%#v\",\n\t\t\t\twant: \"%#v\"", err, w.err)
		}
		if !reflect.DeepEqual(gotRes, w.wantRes) {
...
func Test_client_StreamUpdate(t *testing.T) {
	...
	type want struct {
		wantRes vald.Vald_StreamUpdateClient
		err     error
	}
	type test struct {
		name       string
	...
	defaultCheckFunc := func(w want, gotRes vald.Vald_StreamUpdateClient, err error) error {
		if !errors.Is(err, w.err) {
			return errors.Errorf("got_error: \"%#v\",\n\t\t\t\twant: \"%#v\"", err, w.err)
		}
		if !reflect.DeepEqual(gotRes, w.wantRes) {
...
func Test_client_StreamUpsert(t *testing.T) {
	...
	type want struct {
		wantRes vald.Vald_StreamUpsertClient
		err     error
	}
	type test struct {
		name       string
	...
	defaultCheckFunc := func(w want, gotRes vald.Vald_StreamUpsertClient, err error) error {
		if !errors.Is(err, w.err) {
			return errors.Errorf("got_error: \"%#v\",\n\t\t\t\twant: \"%#v\"", err, w.err)
		}
		if !reflect.DeepEqual(gotRes, w.wantRes) {
...
func Test_client_StreamRemove(t *testing.T) {
	...
	type want struct {
		wantRes vald.Vald_StreamRemoveClient
		err     error
	}
	type test struct {
		name       string
	...
	defaultCheckFunc := func(w want, gotRes vald.Vald_StreamRemoveClient, err error) error {
		if !errors.Is(err, w.err) {
			return errors.Errorf("got_error: \"%#v\",\n\t\t\t\twant: \"%#v\"", err, w.err)
		}
		if !reflect.DeepEqual(gotRes, w.wantRes) {
...
func Test_client_StreamGetObject(t *testing.T) {
	...
	type want struct {
		wantRes vald.Vald_StreamGetObjectClient
		err     error
	}
	type test struct {
		name       string
	...
	defaultCheckFunc := func(w want, gotRes vald.Vald_StreamGetObjectClient, err error) error {
		if !errors.Is(err, w.err) {
			return errors.Errorf("got_error: \"%#v\",\n\t\t\t\twant: \"%#v\"", err, w.err)
		}
		if !reflect.DeepEqual(gotRes, w.wantRes) {
