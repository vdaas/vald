...
go/deps:
	...
	sed -i '/github\.com\/grafana\/grafana-foundation-sdk\/go/d' $(ROOTDIR)/hack/go.mod.default
	echo "require github.com/grafana/grafana-foundation-sdk/go v$(GRAFANA_VERSION).x+cog-v0.0.x" >> $(ROOTDIR)/hack/go.mod.default
