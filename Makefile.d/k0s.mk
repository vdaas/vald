...
k0s/vs/start: k0s/start
	...
	&& curl -fsSL https://github.com/kubernetes-csi/csi-driver-host-path/archive/refs/tags/$(CSI_DRIVER_HOST_PATH_VERSION).tar.gz | \
	tar zxf - -C $(TEMP_DIR)/csi-driver-hostpath --strip-components 1 \
