...
docker/build/gateway-meta: docker/build/base
	docker build -f dockers/gateway/meta/Dockerfile -t $(REPO)/$(META_GATEWAY_IMAGE) .
...
docker/build/gateway-backup: docker/build/base
	docker build -f dockers/gateway/backup/Dockerfile -t $(REPO)/$(BACKUP_GATEWAY_IMAGE) .
...
docker/build/gateway-filter: docker/build/base
	docker build -f dockers/gateway/filter/Dockerfile -t $(REPO)/$(FILTER_GATEWAY_IMAGE) .
...
docker/build/gateway-lb: docker/build/base
	docker build -f dockers/gateway/lb/Dockerfile -t $(REPO)/$(LB_GATEWAY_IMAGE) .
