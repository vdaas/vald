...
func TestNewBackup(t *testing.T) {
	...
	type test struct {
		...
		args       args
		want       want
		checkFunc  func(want, Backup, error) error
	...
	for _, tc := range tests {
		...
		t.Run(test.name, func(tt *testing.T) {
			...
			gotBu, err := NewBackup(test.args.opts...)
...
func Test_backup_GetObject(t *testing.T) {
	...
	type want struct {
		wantVec *payload.Backup_Compressed_Vector
		err     error
	}
	type test struct {
		name       string
	...
	defaultCheckFunc := func(w want, gotVec *payload.Backup_Compressed_Vector, err error) error {
		if !errors.Is(err, w.err) {
			return errors.Errorf("got_error: \"%#v\",\n\t\t\t\twant: \"%#v\"", err, w.err)
		}
	...
	for _, tc := range tests {
		...
		t.Run(test.name, func(tt *testing.T) {
			...
			gotVec, err := b.GetObject(test.args.ctx, test.args.uuid)
...
func Test_backup_GetLocation(t *testing.T) {
	...
	for _, tc := range tests {
		...
		t.Run(test.name, func(tt *testing.T) {
			...
			gotIpList, err := b.GetLocation(test.args.ctx, test.args.uuid)
...
func Test_backup_Register(t *testing.T) {
	...
	type args struct {
		ctx context.Context
		vec *payload.Backup_Compressed_Vector
	}
	type fields struct {
		client grpc.Client
	}
	...
	for _, tc := range tests {
		...
		t.Run(test.name, func(tt *testing.T) {
			...
			err := b.Register(test.args.ctx, test.args.vec)
...
func Test_backup_RegisterMultiple(t *testing.T) {
	...
	for _, tc := range tests {
		...
		t.Run(test.name, func(tt *testing.T) {
			...
			err := b.RegisterMultiple(test.args.ctx, test.args.vecs)
			if err := test.checkFunc(test.want, err); err != nil {
				tt.Errorf("error = %v", err)
			}
		})
...
func Test_backup_Remove(t *testing.T) {
	...
	for _, tc := range tests {
		...
		t.Run(test.name, func(tt *testing.T) {
			...
			err := b.Remove(test.args.ctx, test.args.uuid)
			if err := test.checkFunc(test.want, err); err != nil {
				tt.Errorf("error = %v", err)
			}
		})
...
func Test_backup_RemoveMultiple(t *testing.T) {
	...
	for _, tc := range tests {
		...
		t.Run(test.name, func(tt *testing.T) {
			...
			err := b.RemoveMultiple(test.args.ctx, test.args.uuids...)
			if err := test.checkFunc(test.want, err); err != nil {
				tt.Errorf("error = %v", err)
			}
		})
...
func Test_backup_RegisterIPs(t *testing.T) {
	...
	for _, tc := range tests {
		...
		t.Run(test.name, func(tt *testing.T) {
			...
			err := b.RegisterIPs(test.args.ctx, test.args.uuid, test.args.ips)
			if err := test.checkFunc(test.want, err); err != nil {
				tt.Errorf("error = %v", err)
			}
		})
...
func Test_backup_RemoveIPs(t *testing.T) {
	...
	for _, tc := range tests {
		...
		t.Run(test.name, func(tt *testing.T) {
			...
			err := b.RemoveIPs(test.args.ctx, test.args.ips)
			if err := test.checkFunc(test.want, err); err != nil {
				tt.Errorf("error = %v", err)
			}
		})
