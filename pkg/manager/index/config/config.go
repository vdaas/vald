...
// Package config stores all server application settings for index manager
package config
...
type Data struct {
	...
	// Indexer represent index manager configuration
...
func NewConfig(path string) (cfg *Data, err error) {
	...
	if cfg.Indexer != nil {
		...
		cfg.Indexer = new(config.Indexer).Bind()
	}
	return cfg, nil
}
