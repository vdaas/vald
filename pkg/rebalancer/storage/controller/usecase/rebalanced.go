...
import (
	...
	handler "github.com/vdaas/vald/pkg/rebalancer/storage/controller/handler/grpc"
	"github.com/vdaas/vald/pkg/rebalancer/storage/controller/handler/rest"
	"github.com/vdaas/vald/pkg/rebalancer/storage/controller/router"
...
func New(cfg *config.Data) (r runner.Runner, err error) {
	...
	rb, err := service.NewRebalancer(
		...
		service.WithJobConfigMapName(cfg.Rebalancer.JobConfigMapName),
		service.WithJobConfigMapNamespace(cfg.Rebalancer.JobConfigMapNamespace),
