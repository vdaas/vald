...
type Data struct {
	...
	// Creation represent index creation configuration
	Creation *config.IndexCreation `json:"creator" yaml:"creator"` //nolint:tagliatelle // fixed by the existing config.yaml wire format, not renameable

	// GlobalConfig represent the global configuration
	config.GlobalConfig `json:",inline" yaml:",inline"`
}

// New loads configurations from file path.
