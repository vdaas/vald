...
// vrsBuilder renders the desired ValdRelease objects for a ValdOperatorRelease CR.
...
func (b *vrsBuilder) buildAgent() agent.Agent {
	...
	mu := intstr.FromString(b.cfg.AgentMaxUnavailable)
	ms := intstr.FromString(b.cfg.AgentMaxSurge)
...
func (b *vrsBuilder) getGatewayIngressPathType() networkingv1.PathType {
...
func (b *vrsBuilder) parseOverlay() error {
	...
	b.overlay = &unstructured.Unstructured{Object: obj}
...
// cluster.
func (b *vrsBuilder) makeOverlayPatch(row k8s.Object) *unstructured.Unstructured {
	if b.overlay == nil {
		return nil
	}
...
func (b *vrsBuilder) buildToleration(nt v1.NodePoolType) *[]corev1.Toleration {
	nt = b.effectiveNodePoolType(nt)
