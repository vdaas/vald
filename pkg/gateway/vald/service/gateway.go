...
type Gateway interface {
	...
	Do(ctx context.Context,
		f func(ctx context.Context, tgt string, vc vald.ValdClient, copts ...grpc.CallOption) error) error
...
func (g *gateway) BroadCast(ctx context.Context,
	f func(ctx context.Context, target string, vc vald.ValdClient, copts ...grpc.CallOption) error) (err error) {
