...
func (s *server) Exists(ctx context.Context, meta *payload.Object_ID) (id *payload.Object_ID, err error) {
	ctx, span := trace.StartSpan(grpc.WithGRPCMethod(ctx, "vald.v1.Object/Exists"), apiName+".Exists")
	defer func() {
		if span != nil {
			span.End()
		}
...
func (s *server) Search(ctx context.Context, req *payload.Search_Request) (res *payload.Search_Response, err error) {
	ctx, span := trace.StartSpan(grpc.WithGRPCMethod(ctx, "vald.v1.Search/Search"), apiName+".Search")
	defer func() {
		if span != nil {
			span.End()
		}
...
func (s *server) SearchByID(ctx context.Context, req *payload.Search_IDRequest) (
	...
	ctx, span := trace.StartSpan(grpc.WithGRPCMethod(ctx, "vald.v1.Search/SearchByID"), apiName+".SearchByID")
	defer func() {
		if span != nil {
			span.End()
		}
...
func (s *server) LinearSearch(ctx context.Context, req *payload.Search_Request) (res *payload.Search_Response, err error) {
	ctx, span := trace.StartSpan(grpc.WithGRPCMethod(ctx, "vald.v1.Search/LinearSearch"), apiName+".LinearSearch")
	defer func() {
		if span != nil {
			span.End()
		}
...
func (s *server) LinearSearchByID(ctx context.Context, req *payload.Search_IDRequest) (
	...
	ctx, span := trace.StartSpan(grpc.WithGRPCMethod(ctx, "vald.v1.Search/LinearSearchByID"), apiName+".LinearSearchByID")
	defer func() {
		if span != nil {
			span.End()
		}
...
func (s *server) Insert(ctx context.Context, req *payload.Insert_Request) (ce *payload.Object_Location, err error) {
	ctx, span := trace.StartSpan(grpc.WithGRPCMethod(ctx, "vald.v1.Insert/Insert"), apiName+".Insert")
	defer func() {
		if span != nil {
			span.End()
		}
...
func (s *server) MultiInsert(ctx context.Context, reqs *payload.Insert_MultiRequest) (locs *payload.Object_Locations, err error) {
	ctx, span := trace.StartSpan(grpc.WithGRPCMethod(ctx, "vald.v1.Insert/MultiInsert"), apiName+".MultiInsert")
	defer func() {
		if span != nil {
			span.End()
		}
...
func (s *server) Remove(ctx context.Context, req *payload.Remove_Request) (locs *payload.Object_Location, err error) {
	ctx, span := trace.StartSpan(grpc.WithGRPCMethod(ctx, "vald.v1.Remove/Remove"), apiName+".Remove")
	defer func() {
		if span != nil {
			span.End()
		}
...
func (s *server) MultiRemove(ctx context.Context, reqs *payload.Remove_MultiRequest) (locs *payload.Object_Locations, err error) {
	ctx, span := trace.StartSpan(grpc.WithGRPCMethod(ctx, "vald.v1.Remove/MultiRemove"), apiName+".MultiRemove")
	defer func() {
		if span != nil {
			span.End()
		}
...
func (s *server) GetObject(ctx context.Context, req *payload.Object_VectorRequest) (vec *payload.Object_Vector, err error) {
	ctx, span := trace.StartSpan(grpc.WithGRPCMethod(ctx, "vald.v1.Object/GetObject"), apiName+".GetObject")
	defer func() {
		if span != nil {
			span.End()
		}
