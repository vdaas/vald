...
func Test_client_GetInverseMultiple(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			gotKeys, err := tt.c.GetInverseMultiple(tt.args.vals...)
			if (err != nil) != tt.wantErr {
				t.Errorf("client.GetInverseMultiple() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if !reflect.DeepEqual(gotKeys, tt.wantKeys) {
				t.Errorf("client.GetInverseMultiple() = %v, want %v", gotKeys, tt.wantKeys)
			}
		})
	}
}
...
func Test_client_deleteByKeys(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := tt.c.deleteByKeys(tt.args.keys...)
			if (err != nil) != tt.wantErr {
				t.Errorf("client.deleteByKeys() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if !reflect.DeepEqual(got, tt.want) {
				t.Errorf("client.deleteByKeys() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func Test_client_deleteByValues(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := tt.c.deleteByValues(tt.args.vals...)
			if (err != nil) != tt.wantErr {
				t.Errorf("client.deleteByValues() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if !reflect.DeepEqual(got, tt.want) {
				t.Errorf("client.deleteByValues() = %v, want %v", got, tt.want)
			}
		})
	}
}
