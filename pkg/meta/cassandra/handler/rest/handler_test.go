...
func Test_handler_GetMeta(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(tt *testing.T) {
			...
			got, err := h.GetMeta(test.args.w, test.args.r)
			if err := test.checkFunc(test.want, got, err); err != nil {
				tt.Errorf("error = %v", err)
			}
...
func Test_handler_GetMetas(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(tt *testing.T) {
			...
			got, err := h.GetMetas(test.args.w, test.args.r)
			if err := test.checkFunc(test.want, got, err); err != nil {
				tt.Errorf("error = %v", err)
			}
...
func Test_handler_GetMetaInverse(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(tt *testing.T) {
			...
			got, err := h.GetMetaInverse(test.args.w, test.args.r)
			if err := test.checkFunc(test.want, got, err); err != nil {
				tt.Errorf("error = %v", err)
			}
...
func Test_handler_GetMetasInverse(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(tt *testing.T) {
			...
			got, err := h.GetMetasInverse(test.args.w, test.args.r)
			if err := test.checkFunc(test.want, got, err); err != nil {
				tt.Errorf("error = %v", err)
			}
...
func Test_handler_SetMeta(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(tt *testing.T) {
			...
			got, err := h.SetMeta(test.args.w, test.args.r)
			if err := test.checkFunc(test.want, got, err); err != nil {
				tt.Errorf("error = %v", err)
			}
...
func Test_handler_SetMetas(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(tt *testing.T) {
			...
			got, err := h.SetMetas(test.args.w, test.args.r)
			if err := test.checkFunc(test.want, got, err); err != nil {
				tt.Errorf("error = %v", err)
			}
...
func Test_handler_DeleteMeta(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(tt *testing.T) {
			...
			got, err := h.DeleteMeta(test.args.w, test.args.r)
			if err := test.checkFunc(test.want, got, err); err != nil {
				tt.Errorf("error = %v", err)
			}
...
func Test_handler_DeleteMetas(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(tt *testing.T) {
			...
			got, err := h.DeleteMetas(test.args.w, test.args.r)
			if err := test.checkFunc(test.want, got, err); err != nil {
				tt.Errorf("error = %v", err)
			}
...
func Test_handler_DeleteMetaInverse(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(tt *testing.T) {
			...
			got, err := h.DeleteMetaInverse(test.args.w, test.args.r)
			if err := test.checkFunc(test.want, got, err); err != nil {
				tt.Errorf("error = %v", err)
			}
...
func Test_handler_DeleteMetasInverse(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(tt *testing.T) {
			...
			got, err := h.DeleteMetasInverse(test.args.w, test.args.r)
			if err := test.checkFunc(test.want, got, err); err != nil {
				tt.Errorf("error = %v", err)
			}
