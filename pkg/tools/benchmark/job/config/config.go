...
func NewConfig(ctx context.Context, path string) (cfg *Data, err error) {
	...
	if err != nil {
		...
		// jobResource.Spec has another field comparing Data.Job, so json.Marshal and Unmarshal are used for embedding field value of Data.Job from jobResource.Spec
