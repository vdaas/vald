...
func (r *runner) processModification(
	...
	case config.OpInsertMeta:
		switch plan.Mode {
		case config.OperationUnary, config.OperationOther:
			return unary(t, ctx, train, plan, r.client.Insert, insertWithMetadataRequest)
		case config.OperationMultiple:
			return multi(t, ctx, train, plan, r.client.MultiInsert, insertWithMetadataRequest, insertMultipleRequest)
		case config.OperationStream:
			stream(t, ctx, train, plan, r.client.StreamInsert, insertWithMetadataRequest)
		}
	...
	case config.OpUpdateMeta:
		switch plan.Mode {
		case config.OperationUnary, config.OperationOther:
			return unary(t, ctx, train, plan, r.client.Update, updateWithMetadataRequest)
		case config.OperationMultiple:
			return multi(t, ctx, train, plan, r.client.MultiUpdate, updateWithMetadataRequest, updateMultipleRequest)
		case config.OperationStream:
			stream(t, ctx, train, plan, r.client.StreamUpdate, updateWithMetadataRequest)
		}
	...
	case config.OpUpsertMeta:
		switch plan.Mode {
		case config.OperationUnary, config.OperationOther:
			return unary(t, ctx, train, plan, r.client.Upsert, upsertWithMetadataRequest)
		case config.OperationMultiple:
			return multi(t, ctx, train, plan, r.client.MultiUpsert, upsertWithMetadataRequest, upsertMultipleRequest)
		case config.OperationStream:
			stream(t, ctx, train, plan, r.client.StreamUpsert, upsertWithMetadataRequest)
		}
