...
func (r *runner) processModification(
	...
	case config.OpInsert:
		...
		case config.OperationStream:
			stream[vald.Insert_StreamInsertClient, *payload.Insert_Request, *payload.Object_Location](t, ctx, train, plan, r.client.StreamInsert, insertRequest)
		}
	case config.OpUpdate:
		...
		case config.OperationStream:
			stream[vald.Update_StreamUpdateClient, *payload.Update_Request, *payload.Object_Location](t, ctx, train, plan, r.client.StreamUpdate, updateRequest)
		}
	case config.OpUpsert:
		...
		case config.OperationStream:
			stream[vald.Upsert_StreamUpsertClient, *payload.Upsert_Request, *payload.Object_Location](t, ctx, train, plan, r.client.StreamUpsert, upsertRequest)
		}
	case config.OpRemove:
		...
		case config.OperationStream:
			stream[vald.Remove_StreamRemoveClient, *payload.Remove_Request, *payload.Object_Location](t, ctx, train, plan, r.client.StreamRemove, removeRequest)
		}
