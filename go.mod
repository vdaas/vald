...
replace (
	...
	github.com/gocql/gocql => github.com/gocql/gocql v0.0.0-20200115135732-617765adbe2d
	...
	golang.org/x/crypto => golang.org/x/crypto v0.0.0-20200115085410-6d4e4cb37c7d
