...
<table>
  ...
  <tr>
    <td>Agent NGT</td>
    <td>
      <code>docker pull vdaas/vald-agent-ngt:v1.0.5</code><br/>
      <code>docker pull ghcr.io/vdaas/vald/vald-agent-ngt:v1.0.5</code>
    </td>
  </tr>
  <tr>
    <td>Agent sidecar</td>
    <td>
      <code>docker pull vdaas/vald-agent-sidecar:v1.0.5</code><br/>
      <code>docker pull ghcr.io/vdaas/vald/vald-agent-sidecar:v1.0.5</code>
    </td>
  </tr>
  <tr>
    <td>Discoverers</td>
    <td>
      <code>docker pull vdaas/vald-discoverer-k8s:v1.0.5</code><br/>
      <code>docker pull ghcr.io/vdaas/vald/vald-discoverer-k8s:v1.0.5</code>
    </td>
  </tr>
  <tr>
    <td>Gateways</td>
    <td>
      <code>docker pull vdaas/vald-gateway:v1.0.5</code><br/>
      <code>docker pull ghcr.io/vdaas/vald/vald-gateway:v1.0.5</code><br/>
      <code>docker pull vdaas/vald-backup-gateway:v1.0.5</code><br/>
      <code>docker pull ghcr.io/vdaas/vald/vald-backup-gateway:v1.0.5</code><br/>
      <code>docker pull vdaas/vald-lb-gateway:v1.0.5</code><br/>
      <code>docker pull ghcr.io/vdaas/vald/vald-lb-gateway:v1.0.5</code><br/>
      <code>docker pull vdaas/vald-meta-gateway:v1.0.5</code><br/>
      <code>docker pull ghcr.io/vdaas/vald/vald-meta-gateway:v1.0.5</code>
    </td>
  </tr>
  <tr>
    <td>Backup managers</td>
    <td>
      <code>docker pull vdaas/vald-manager-backup-mysql:v1.0.5</code><br/>
      <code>docker pull ghcr.io/vdaas/vald/vald-manager-backup-mysql:v1.0.5</code><br/>
      <code>docker pull vdaas/vald-manager-backup-cassandra:v1.0.5</code><br/>
      <code>docker pull ghcr.io/vdaas/vald/vald-manager-backup-cassandra:v1.0.5</code>
    </td>
  </tr>
  <tr>
    <td>Compressor</td>
    <td>
      <code>docker pull vdaas/vald-manager-compressor:v1.0.5</code><br/>
      <code>docker pull ghcr.io/vdaas/vald/vald-manager-compressor:v1.0.5</code>
    </td>
  </tr>
  <tr>
    <td>Metas</td>
    <td>
      <code>docker pull vdaas/vald-meta-redis:v1.0.5</code><br/>
      <code>docker pull ghcr.io/vdaas/vald/vald-meta-redis:v1.0.5</code><br/>
      <code>docker pull vdaas/vald-meta-cassandra:v1.0.5</code><br/>
      <code>docker pull ghcr.io/vdaas/vald/vald-meta-cassandra:v1.0.5</code>
    </td>
  </tr>
  <tr>
    <td>Index Manager</td>
    <td>
      <code>docker pull vdaas/vald-manager-index:v1.0.5</code><br/>
      <code>docker pull ghcr.io/vdaas/vald/vald-manager-index:v1.0.5</code>
    </td>
  </tr>
  <tr>
    <td>Helm Operator</td>
    <td>
      <code>docker pull vdaas/vald-helm-operator:v1.0.5</code><br/>
      <code>docker pull ghcr.io/vdaas/vald/vald-helm-operator:v1.0.5</code>
    </td>
  </tr>
</table>

### Documents
- [GoDoc](https://pkg.go.dev/github.com/vdaas/vald@v1.0.5)
- [Helm Chart Reference](https://github.com/vdaas/vald/blob/v1.0.5/charts/vald/README.md)
- [Helm Operator Chart Reference](https://github.com/vdaas/vald/blob/v1.0.5/charts/vald-helm-operator/README.md)

### Changes
<!--- Provide a general summary of your changes in the Title above -->

### Description:
agent component returns internal server error, but some case it should be return NotFound, AlreadyExists, etc...

I added 4 changes.
- agent vqueue api for correct not found control
- agent readyForUpdate function return value changed from boolean to error type
- add gRPC status convertor to internal/trace package
- add gRPC error status parser
