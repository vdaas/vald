...
func TestNewStreamRemove(t *testing.T) {
	...
	for _, tc := range tests {
		...
		t.Run(test.name, func(tt *testing.T) {
			...
			got := NewStreamRemove(test.args.opts...)
...
func Test_streamRemove_dataProvider(t *testing.T) {
	...
	for _, tc := range tests {
		...
		t.Run(test.name, func(tt *testing.T) {
			...
			got := sr.dataProvider(test.args.total, test.args.b, test.args.dataset)
			if err := test.checkFunc(test.want, got); err != nil {
				tt.Errorf("error = %v", err)
			}
		})
...
func Test_streamRemove_Run(t *testing.T) {
	...
	for _, tc := range tests {
		...
		t.Run(test.name, func(tt *testing.T) {
			...
			sr.Run(test.args.ctx, test.args.b, test.args.c, test.args.dataset)
