...
func Test_objectVectorsToNgtdMultiInsertRequest(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := objectVectorsToNgtdMultiInsertRequest(tt.args.in); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("objectVectorsToNgtdMultiInsertRequest() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func Test_objectIDsToNgtdMultiRemoveRequest(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := objectIDsToNgtdMultiRemoveRequest(tt.args.in); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("objectIDsToNgtdMultiRemoveRequest() = %v, want %v", got, tt.want)
			}
		})
	}
}
