...
func Test_searchRequestToNgtdSearchRequest(t *testing.T) {
	...
	type want struct {
		want *model.SearchRequest
	}
	type test struct {
		name       string
		args       args
		want       want
		checkFunc  func(want, *model.SearchRequest) error
		beforeFunc func(args)
		afterFunc  func(args)
	}
	defaultCheckFunc := func(w want, got *model.SearchRequest) error {
		if !reflect.DeepEqual(got, w.want) {
			return errors.Errorf("got = %v, want %v", got, w.want)
		}
		return nil
...
func Test_objectVectorToNgtdInsertRequest(t *testing.T) {
	...
	type want struct {
		want *model.InsertRequest
	}
	type test struct {
		name       string
		args       args
		want       want
		checkFunc  func(want, *model.InsertRequest) error
		beforeFunc func(args)
		afterFunc  func(args)
	}
	defaultCheckFunc := func(w want, got *model.InsertRequest) error {
		if !reflect.DeepEqual(got, w.want) {
			return errors.Errorf("got = %v, want %v", got, w.want)
		}
		return nil
...
func Test_objectVectorsToNgtdMultiInsertRequest(t *testing.T) {
	type args struct {
		in *client.ObjectVectors
	}
	type want struct {
		want *model.MultiInsertRequest
	}
	type test struct {
		name       string
		args       args
		want       want
		checkFunc  func(want, *model.MultiInsertRequest) error
		beforeFunc func(args)
		afterFunc  func(args)
	}
	defaultCheckFunc := func(w want, got *model.MultiInsertRequest) error {
		if !reflect.DeepEqual(got, w.want) {
			return errors.Errorf("got = %v, want %v", got, w.want)
		}
		return nil
	...
	for _, test := range tests {
		t.Run(test.name, func(tt *testing.T) {
			...
			got := objectVectorsToNgtdMultiInsertRequest(test.args.in)
			if err := test.checkFunc(test.want, got); err != nil {
				tt.Errorf("error = %v", err)
			}
...
func Test_objectIDsToNgtdMultiRemoveRequest(t *testing.T) {
	type args struct {
		in *client.ObjectIDs
	}
	type want struct {
		want *model.MultiRemoveRequest
	}
	type test struct {
		name       string
		args       args
		want       want
		checkFunc  func(want, *model.MultiRemoveRequest) error
		beforeFunc func(args)
		afterFunc  func(args)
	}
	defaultCheckFunc := func(w want, got *model.MultiRemoveRequest) error {
		if !reflect.DeepEqual(got, w.want) {
			return errors.Errorf("got = %v, want %v", got, w.want)
		}
		return nil
	...
	for _, test := range tests {
		t.Run(test.name, func(tt *testing.T) {
			...
			got := objectIDsToNgtdMultiRemoveRequest(test.args.in)
			if err := test.checkFunc(test.want, got); err != nil {
				tt.Errorf("error = %v", err)
			}
...
func Test_getSizeAndEpsilon(t *testing.T) {
	...
	type test struct {
		...
		args       args
		want       want
		checkFunc  func(want, int, float32) error
		beforeFunc func(args)
		afterFunc  func(args)
	}
	defaultCheckFunc := func(w want, gotSize int, gotEpsilon float32) error {
		...
		if !reflect.DeepEqual(gotEpsilon, w.wantEpsilon) {
			return errors.Errorf("got = %v, want %v", gotEpsilon, w.wantEpsilon)
		}
		return nil
	}
	tests := []test{
...
func Test_tofloat64(t *testing.T) {
	...
	defaultCheckFunc := func(w want, gotOut []float64) error {
		if !reflect.DeepEqual(gotOut, w.wantOut) {
			return errors.Errorf("got = %v, want %v", gotOut, w.wantOut)
		}
		return nil
	}
	tests := []test{
