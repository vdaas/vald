...
const file_v1_payload_payload_proto_rawDesc = "" +
	...
	"\x04node\x18\x03 \x01(\tR\x04node\"\x8d0\n" +
	"\x04Info\x1a\xb2 \n" +
	"\x05Index\x1au\n" +
	"\x05Count\x12\x16\n" +
...
var file_v1_payload_payload_proto_msgTypes = make([]protoimpl.MessageInfo, 106)
var file_v1_payload_payload_proto_goTypes = []any{
	...
	(*Info_Stats_ResourceStats)(nil),       // 97: payload.v1.Info.Stats.ResourceStats
	(*Info_Stats_ResourceStatsDetail)(nil), // 98: payload.v1.Info.Stats.ResourceStatsDetail
	(*Info_Stats_CgroupStats)(nil),         // 99: payload.v1.Info.Stats.CgroupStats
	nil,                                    // 100: payload.v1.Info.Stats.ResourceStatsDetail.DetailsEntry
...
var file_v1_payload_payload_proto_depIdxs = []int32{
	...
	109, // 48: payload.v1.Object.StreamDistance.status:type_name -> google.rpc.Status
	...
	109, // 52: payload.v1.Object.StreamVector.status:type_name -> google.rpc.Status
	61,  // 53: payload.v1.Object.StreamBlob.blob:type_name -> payload.v1.Object.Blob
	109, // 54: payload.v1.Object.StreamBlob.status:type_name -> google.rpc.Status
	63,  // 55: payload.v1.Object.StreamLocation.location:type_name -> payload.v1.Object.Location
	109, // 56: payload.v1.Object.StreamLocation.status:type_name -> google.rpc.Status
	...
	109, // 59: payload.v1.Object.List.Response.status:type_name -> google.rpc.Status
	...
	101, // 69: payload.v1.Info.Labels.labels:type_name -> payload.v1.Info.Labels.LabelsEntry
	102, // 70: payload.v1.Info.Annotations.annotations:type_name -> payload.v1.Info.Annotations.AnnotationsEntry
	...
	99,  // 80: payload.v1.Info.Stats.ResourceStats.cgroup_stats:type_name -> payload.v1.Info.Stats.CgroupStats
	100, // 81: payload.v1.Info.Stats.ResourceStatsDetail.details:type_name -> payload.v1.Info.Stats.ResourceStatsDetail.DetailsEntry
	97,  // 82: payload.v1.Info.Stats.ResourceStatsDetail.DetailsEntry.value:type_name -> payload.v1.Info.Stats.ResourceStats
	103, // 83: payload.v1.Mirror.Targets.targets:type_name -> payload.v1.Mirror.Target
	110, // 84: payload.v1.Meta.Value.value:type_name -> google.protobuf.Any
	105, // 85: payload.v1.Meta.KeyValue.key:type_name -> payload.v1.Meta.Key
	106, // 86: payload.v1.Meta.KeyValue.value:type_name -> payload.v1.Meta.Value
