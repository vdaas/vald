...
var file_apis_proto_v1_payload_payload_proto_rawDesc = []byte{
	...
	0x03, 0x28, 0x09, 0x52, 0x02, 0x69, 0x70, 0x22, 0x7a, 0x0a, 0x06, 0x4d, 0x69, 0x72, 0x72, 0x6f,
	...
	,
	...
	0x2f, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0xa2, 0x02, 0x07, 0x50, 0x61, 0x79, 0x6c, 0x6f,
...
var file_apis_proto_v1_payload_payload_proto_msgTypes = make([]protoimpl.MessageInfo, 77)
var file_apis_proto_v1_payload_payload_proto_goTypes = []interface{}{
	...
	(*Mirror_Target)(nil),               // 77: payload.v1.Mirror.Target
	(*Mirror_Targets)(nil),              // 78: payload.v1.Mirror.Targets
...
var file_apis_proto_v1_payload_payload_proto_depIdxs = []int32{
	...
	79, // 13: payload.v1.Search.StreamResponse.status:type_name -> google.rpc.Status
	...
	55, // 34: payload.v1.Upsert.ObjectRequest.object:type_name -> payload.v1.Object.Blob
	...
	79, // 47: payload.v1.Object.StreamDistance.status:type_name -> google.rpc.Status
	51, // 48: payload.v1.Object.Vectors.vectors:type_name -> payload.v1.Object.Vector
	51, // 49: payload.v1.Object.StreamVector.vector:type_name -> payload.v1.Object.Vector
	79, // 50: payload.v1.Object.StreamVector.status:type_name -> google.rpc.Status
	55, // 51: payload.v1.Object.StreamBlob.blob:type_name -> payload.v1.Object.Blob
	79, // 52: payload.v1.Object.StreamBlob.status:type_name -> google.rpc.Status
	57, // 53: payload.v1.Object.StreamLocation.location:type_name -> payload.v1.Object.Location
	79, // 54: payload.v1.Object.StreamLocation.status:type_name -> google.rpc.Status
	57, // 55: payload.v1.Object.Locations.locations:type_name -> payload.v1.Object.Location
	51, // 56: payload.v1.Object.List.Response.vector:type_name -> payload.v1.Object.Vector
	79, // 57: payload.v1.Object.List.Response.status:type_name -> google.rpc.Status
	68, // 58: payload.v1.Info.Pod.cpu:type_name -> payload.v1.Info.CPU
	69, // 59: payload.v1.Info.Pod.memory:type_name -> payload.v1.Info.Memory
	67, // 60: payload.v1.Info.Pod.node:type_name -> payload.v1.Info.Node
	68, // 61: payload.v1.Info.Node.cpu:type_name -> payload.v1.Info.CPU
	69, // 62: payload.v1.Info.Node.memory:type_name -> payload.v1.Info.Memory
	70, // 63: payload.v1.Info.Node.Pods:type_name -> payload.v1.Info.Pods
	66, // 64: payload.v1.Info.Pods.pods:type_name -> payload.v1.Info.Pod
	67, // 65: payload.v1.Info.Nodes.nodes:type_name -> payload.v1.Info.Node
	77, // 66: payload.v1.Mirror.Targets.targets:type_name -> payload.v1.Mirror.Target
