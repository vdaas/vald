...
type Filter_Target struct {
	...
	// The target query.
	Query *Filter_Query `protobuf:"bytes,3,opt,name=query,proto3" json:"query,omitempty"`
}
...
func (x *Filter_Target) GetQuery() *Filter_Query {
	if x != nil {
		return x.Query
	}
	return nil
...
var file_apis_proto_v1_payload_payload_proto_rawDesc = []byte{
	...
	0x6f, 0x61, 0x64, 0x22, 0xc8, 0x01, 0x0a, 0x06, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x1a, 0x60,
	...
	0x12, 0x2e, 0x0a, 0x05, 0x71, 0x75, 0x65, 0x72, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x3d, 0x0a, 0x06, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x33, 0x0a, 0x07, 0x74, 0x61, 0x72,
	...
	0x61, 0x72, 0x67, 0x65, 0x74, 0x52, 0x07, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x73, 0x22, 0xe5,
...
var file_apis_proto_v1_payload_payload_proto_msgTypes = make([]protoimpl.MessageInfo, 70)
...
var file_apis_proto_v1_payload_payload_proto_depIdxs = []int32{
	...
	70, // 12: payload.v1.Search.StreamResponse.status:type_name -> google.rpc.Status
	22, // 13: payload.v1.Filter.Target.query:type_name -> payload.v1.Filter.Query
	21, // 14: payload.v1.Filter.Config.targets:type_name -> payload.v1.Filter.Target
	...
	21, // 20: payload.v1.Insert.ObjectRequest.vectorizer:type_name -> payload.v1.Filter.Target
	...
	21, // 28: payload.v1.Update.ObjectRequest.vectorizer:type_name -> payload.v1.Filter.Target
	...
	21, // 36: payload.v1.Upsert.ObjectRequest.vectorizer:type_name -> payload.v1.Filter.Target
