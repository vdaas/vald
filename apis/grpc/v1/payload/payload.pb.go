...
var file_v1_payload_payload_proto_depIdxs = []int32{
	...
	54, // 10: payload.v1.Search.Response.results:type_name -> payload.v1.Object.Distance
	...
	95, // 13: payload.v1.Search.StreamResponse.status:type_name -> google.rpc.Status
	25, // 14: payload.v1.Filter.Config.target:type_name -> payload.v1.Filter.Target
	26, // 15: payload.v1.Filter.Config.query:type_name -> payload.v1.Filter.Query
	54, // 16: payload.v1.Filter.DistanceRequest.distance:type_name -> payload.v1.Object.Distance
	26, // 17: payload.v1.Filter.DistanceRequest.query:type_name -> payload.v1.Filter.Query
	54, // 18: payload.v1.Filter.DistanceResponse.distance:type_name -> payload.v1.Object.Distance
	58, // 19: payload.v1.Filter.VectorRequest.vector:type_name -> payload.v1.Object.Vector
	26, // 20: payload.v1.Filter.VectorRequest.query:type_name -> payload.v1.Filter.Query
	58, // 21: payload.v1.Filter.VectorResponse.vector:type_name -> payload.v1.Object.Vector
	58, // 22: payload.v1.Insert.Request.vector:type_name -> payload.v1.Object.Vector
	36, // 23: payload.v1.Insert.Request.config:type_name -> payload.v1.Insert.Config
	32, // 24: payload.v1.Insert.MultiRequest.requests:type_name -> payload.v1.Insert.Request
	64, // 25: payload.v1.Insert.ObjectRequest.object:type_name -> payload.v1.Object.Blob
	36, // 26: payload.v1.Insert.ObjectRequest.config:type_name -> payload.v1.Insert.Config
	25, // 27: payload.v1.Insert.ObjectRequest.vectorizer:type_name -> payload.v1.Filter.Target
	34, // 28: payload.v1.Insert.MultiObjectRequest.requests:type_name -> payload.v1.Insert.ObjectRequest
	27, // 29: payload.v1.Insert.Config.filters:type_name -> payload.v1.Filter.Config
	58, // 30: payload.v1.Update.Request.vector:type_name -> payload.v1.Object.Vector
	41, // 31: payload.v1.Update.Request.config:type_name -> payload.v1.Update.Config
	37, // 32: payload.v1.Update.MultiRequest.requests:type_name -> payload.v1.Update.Request
	64, // 33: payload.v1.Update.ObjectRequest.object:type_name -> payload.v1.Object.Blob
	41, // 34: payload.v1.Update.ObjectRequest.config:type_name -> payload.v1.Update.Config
	25, // 35: payload.v1.Update.ObjectRequest.vectorizer:type_name -> payload.v1.Filter.Target
	39, // 36: payload.v1.Update.MultiObjectRequest.requests:type_name -> payload.v1.Update.ObjectRequest
	27, // 37: payload.v1.Update.Config.filters:type_name -> payload.v1.Filter.Config
	58, // 38: payload.v1.Upsert.Request.vector:type_name -> payload.v1.Object.Vector
	46, // 39: payload.v1.Upsert.Request.config:type_name -> payload.v1.Upsert.Config
	42, // 40: payload.v1.Upsert.MultiRequest.requests:type_name -> payload.v1.Upsert.Request
	64, // 41: payload.v1.Upsert.ObjectRequest.object:type_name -> payload.v1.Object.Blob
	46, // 42: payload.v1.Upsert.ObjectRequest.config:type_name -> payload.v1.Upsert.Config
	25, // 43: payload.v1.Upsert.ObjectRequest.vectorizer:type_name -> payload.v1.Filter.Target
	44, // 44: payload.v1.Upsert.MultiObjectRequest.requests:type_name -> payload.v1.Upsert.ObjectRequest
	27, // 45: payload.v1.Upsert.Config.filters:type_name -> payload.v1.Filter.Config
	56, // 46: payload.v1.Remove.Request.id:type_name -> payload.v1.Object.ID
	51, // 47: payload.v1.Remove.Request.config:type_name -> payload.v1.Remove.Config
	47, // 48: payload.v1.Remove.MultiRequest.requests:type_name -> payload.v1.Remove.Request
	50, // 49: payload.v1.Remove.TimestampRequest.timestamps:type_name -> payload.v1.Remove.Timestamp
	1,  // 50: payload.v1.Remove.Timestamp.operator:type_name -> payload.v1.Remove.Timestamp.Operator
	56, // 51: payload.v1.Object.VectorRequest.id:type_name -> payload.v1.Object.ID
	27, // 52: payload.v1.Object.VectorRequest.filters:type_name -> payload.v1.Filter.Config
	54, // 53: payload.v1.Object.StreamDistance.distance:type_name -> payload.v1.Object.Distance
	95, // 54: payload.v1.Object.StreamDistance.status:type_name -> google.rpc.Status
	56, // 55: payload.v1.Object.GetTimestampRequest.id:type_name -> payload.v1.Object.ID
	58, // 56: payload.v1.Object.Vectors.vectors:type_name -> payload.v1.Object.Vector
	58, // 57: payload.v1.Object.StreamVector.vector:type_name -> payload.v1.Object.Vector
	95, // 58: payload.v1.Object.StreamVector.status:type_name -> google.rpc.Status
	64, // 59: payload.v1.Object.StreamBlob.blob:type_name -> payload.v1.Object.Blob
	95, // 60: payload.v1.Object.StreamBlob.status:type_name -> google.rpc.Status
	66, // 61: payload.v1.Object.StreamLocation.location:type_name -> payload.v1.Object.Location
	95, // 62: payload.v1.Object.StreamLocation.status:type_name -> google.rpc.Status
	66, // 63: payload.v1.Object.Locations.locations:type_name -> payload.v1.Object.Location
	58, // 64: payload.v1.Object.List.Response.vector:type_name -> payload.v1.Object.Vector
	95, // 65: payload.v1.Object.List.Response.status:type_name -> google.rpc.Status
	81, // 66: payload.v1.Info.Pod.cpu:type_name -> payload.v1.Info.CPU
	82, // 67: payload.v1.Info.Pod.memory:type_name -> payload.v1.Info.Memory
	76, // 68: payload.v1.Info.Pod.node:type_name -> payload.v1.Info.Node
	81, // 69: payload.v1.Info.Node.cpu:type_name -> payload.v1.Info.CPU
	82, // 70: payload.v1.Info.Node.memory:type_name -> payload.v1.Info.Memory
	83, // 71: payload.v1.Info.Node.Pods:type_name -> payload.v1.Info.Pods
	78, // 72: payload.v1.Info.Service.ports:type_name -> payload.v1.Info.ServicePort
	79, // 73: payload.v1.Info.Service.labels:type_name -> payload.v1.Info.Labels
	80, // 74: payload.v1.Info.Service.annotations:type_name -> payload.v1.Info.Annotations
	91, // 75: payload.v1.Info.Labels.labels:type_name -> payload.v1.Info.Labels.LabelsEntry
	92, // 76: payload.v1.Info.Annotations.annotations:type_name -> payload.v1.Info.Annotations.AnnotationsEntry
	75, // 77: payload.v1.Info.Pods.pods:type_name -> payload.v1.Info.Pod
	76, // 78: payload.v1.Info.Nodes.nodes:type_name -> payload.v1.Info.Node
	77, // 79: payload.v1.Info.Services.services:type_name -> payload.v1.Info.Service
	93, // 80: payload.v1.Mirror.Targets.targets:type_name -> payload.v1.Mirror.Target
