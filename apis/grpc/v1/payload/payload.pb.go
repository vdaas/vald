...
var file_apis_proto_v1_payload_payload_proto_goTypes = []interface{}{
	...
	(*Info_CPU)(nil),                    // 70: payload.v1.Info.CPU
	(*Info_Memory)(nil),                 // 71: payload.v1.Info.Memory
	(*Info_Pods)(nil),                   // 72: payload.v1.Info.Pods
	(*Info_Nodes)(nil),                  // 73: payload.v1.Info.Nodes
	(*Info_IPs)(nil),                    // 74: payload.v1.Info.IPs
	(*Info_Index_Count)(nil),            // 75: payload.v1.Info.Index.Count
	(*Info_Index_UUID)(nil),             // 76: payload.v1.Info.Index.UUID
	(*Info_Index_UUID_Committed)(nil),   // 77: payload.v1.Info.Index.UUID.Committed
	(*Info_Index_UUID_Uncommitted)(nil), // 78: payload.v1.Info.Index.UUID.Uncommitted
	(*Mirror_Target)(nil),               // 79: payload.v1.Mirror.Target
	(*Mirror_Targets)(nil),              // 80: payload.v1.Mirror.Targets
...
var file_apis_proto_v1_payload_payload_proto_depIdxs = []int32{
	...
	70, // 59: payload.v1.Info.Pod.cpu:type_name -> payload.v1.Info.CPU
	71, // 60: payload.v1.Info.Pod.memory:type_name -> payload.v1.Info.Memory
	69, // 61: payload.v1.Info.Pod.node:type_name -> payload.v1.Info.Node
	70, // 62: payload.v1.Info.Node.cpu:type_name -> payload.v1.Info.CPU
	71, // 63: payload.v1.Info.Node.memory:type_name -> payload.v1.Info.Memory
	72, // 64: payload.v1.Info.Node.Pods:type_name -> payload.v1.Info.Pods
	...
	79, // 67: payload.v1.Mirror.Targets.targets:type_name -> payload.v1.Mirror.Target
...
func file_apis_proto_v1_payload_payload_proto_init() {
	...
	file_apis_proto_v1_payload_payload_proto_msgTypes[62].OneofWrappers = []interface{}{
