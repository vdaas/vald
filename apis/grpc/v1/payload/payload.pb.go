...
var file_v1_payload_payload_proto_msgTypes = make([]protoimpl.MessageInfo, 91)
var file_v1_payload_payload_proto_goTypes = []interface{}{
	...
	(*Filter_Query)(nil),                // 25: payload.v1.Filter.Query
	(*Filter_Config)(nil),               // 26: payload.v1.Filter.Config
	(*Filter_DistanceRequest)(nil),      // 27: payload.v1.Filter.DistanceRequest
	(*Filter_DistanceResponse)(nil),     // 28: payload.v1.Filter.DistanceResponse
	(*Filter_VectorRequest)(nil),        // 29: payload.v1.Filter.VectorRequest
	(*Filter_VectorResponse)(nil),       // 30: payload.v1.Filter.VectorResponse
	(*Insert_Request)(nil),              // 31: payload.v1.Insert.Request
	(*Insert_MultiRequest)(nil),         // 32: payload.v1.Insert.MultiRequest
	(*Insert_ObjectRequest)(nil),        // 33: payload.v1.Insert.ObjectRequest
	(*Insert_MultiObjectRequest)(nil),   // 34: payload.v1.Insert.MultiObjectRequest
	(*Insert_Config)(nil),               // 35: payload.v1.Insert.Config
	(*Update_Request)(nil),              // 36: payload.v1.Update.Request
	(*Update_MultiRequest)(nil),         // 37: payload.v1.Update.MultiRequest
	(*Update_ObjectRequest)(nil),        // 38: payload.v1.Update.ObjectRequest
	(*Update_MultiObjectRequest)(nil),   // 39: payload.v1.Update.MultiObjectRequest
	(*Update_Config)(nil),               // 40: payload.v1.Update.Config
	(*Upsert_Request)(nil),              // 41: payload.v1.Upsert.Request
	(*Upsert_MultiRequest)(nil),         // 42: payload.v1.Upsert.MultiRequest
	(*Upsert_ObjectRequest)(nil),        // 43: payload.v1.Upsert.ObjectRequest
	(*Upsert_MultiObjectRequest)(nil),   // 44: payload.v1.Upsert.MultiObjectRequest
	(*Upsert_Config)(nil),               // 45: payload.v1.Upsert.Config
	(*Remove_Request)(nil),              // 46: payload.v1.Remove.Request
	(*Remove_MultiRequest)(nil),         // 47: payload.v1.Remove.MultiRequest
	(*Remove_TimestampRequest)(nil),     // 48: payload.v1.Remove.TimestampRequest
	(*Remove_Timestamp)(nil),            // 49: payload.v1.Remove.Timestamp
	(*Remove_Config)(nil),               // 50: payload.v1.Remove.Config
	(*Object_VectorRequest)(nil),        // 51: payload.v1.Object.VectorRequest
	(*Object_Distance)(nil),             // 52: payload.v1.Object.Distance
	(*Object_StreamDistance)(nil),       // 53: payload.v1.Object.StreamDistance
	(*Object_ID)(nil),                   // 54: payload.v1.Object.ID
	(*Object_IDs)(nil),                  // 55: payload.v1.Object.IDs
	(*Object_Vector)(nil),               // 56: payload.v1.Object.Vector
	(*Object_GetTimestampRequest)(nil),  // 57: payload.v1.Object.GetTimestampRequest
	(*Object_Timestamp)(nil),            // 58: payload.v1.Object.Timestamp
	(*Object_Vectors)(nil),              // 59: payload.v1.Object.Vectors
	(*Object_StreamVector)(nil),         // 60: payload.v1.Object.StreamVector
	(*Object_ReshapeVector)(nil),        // 61: payload.v1.Object.ReshapeVector
	(*Object_Blob)(nil),                 // 62: payload.v1.Object.Blob
	(*Object_StreamBlob)(nil),           // 63: payload.v1.Object.StreamBlob
	(*Object_Location)(nil),             // 64: payload.v1.Object.Location
	(*Object_StreamLocation)(nil),       // 65: payload.v1.Object.StreamLocation
	(*Object_Locations)(nil),            // 66: payload.v1.Object.Locations
	(*Object_List)(nil),                 // 67: payload.v1.Object.List
	(*Object_List_Request)(nil),         // 68: payload.v1.Object.List.Request
	(*Object_List_Response)(nil),        // 69: payload.v1.Object.List.Response
	(*Control_CreateIndexRequest)(nil),  // 70: payload.v1.Control.CreateIndexRequest
	(*Discoverer_Request)(nil),          // 71: payload.v1.Discoverer.Request
	(*Info_Index)(nil),                  // 72: payload.v1.Info.Index
	...
	(*Info_Index_UUID_Committed)(nil),   // 87: payload.v1.Info.Index.UUID.Committed
	(*Info_Index_UUID_Uncommitted)(nil), // 88: payload.v1.Info.Index.UUID.Uncommitted
	nil,                                 // 89: payload.v1.Info.Labels.LabelsEntry
	nil,                                 // 90: payload.v1.Info.Annotations.AnnotationsEntry
	(*Mirror_Target)(nil),               // 91: payload.v1.Mirror.Target
	(*Mirror_Targets)(nil),              // 92: payload.v1.Mirror.Targets
...
var file_v1_payload_payload_proto_depIdxs = []int32{
	...
	52, // 10: payload.v1.Search.Response.results:type_name -> payload.v1.Object.Distance
	...
	93, // 13: payload.v1.Search.StreamResponse.status:type_name -> google.rpc.Status
	24, // 14: payload.v1.Filter.Config.target:type_name -> payload.v1.Filter.Target
	25, // 15: payload.v1.Filter.Config.query:type_name -> payload.v1.Filter.Query
	52, // 16: payload.v1.Filter.DistanceRequest.distance:type_name -> payload.v1.Object.Distance
	25, // 17: payload.v1.Filter.DistanceRequest.query:type_name -> payload.v1.Filter.Query
	52, // 18: payload.v1.Filter.DistanceResponse.distance:type_name -> payload.v1.Object.Distance
	56, // 19: payload.v1.Filter.VectorRequest.vector:type_name -> payload.v1.Object.Vector
	25, // 20: payload.v1.Filter.VectorRequest.query:type_name -> payload.v1.Filter.Query
	56, // 21: payload.v1.Filter.VectorResponse.vector:type_name -> payload.v1.Object.Vector
	56, // 22: payload.v1.Insert.Request.vector:type_name -> payload.v1.Object.Vector
	35, // 23: payload.v1.Insert.Request.config:type_name -> payload.v1.Insert.Config
	31, // 24: payload.v1.Insert.MultiRequest.requests:type_name -> payload.v1.Insert.Request
	62, // 25: payload.v1.Insert.ObjectRequest.object:type_name -> payload.v1.Object.Blob
	35, // 26: payload.v1.Insert.ObjectRequest.config:type_name -> payload.v1.Insert.Config
	24, // 27: payload.v1.Insert.ObjectRequest.vectorizer:type_name -> payload.v1.Filter.Target
	33, // 28: payload.v1.Insert.MultiObjectRequest.requests:type_name -> payload.v1.Insert.ObjectRequest
	26, // 29: payload.v1.Insert.Config.filters:type_name -> payload.v1.Filter.Config
	56, // 30: payload.v1.Update.Request.vector:type_name -> payload.v1.Object.Vector
	40, // 31: payload.v1.Update.Request.config:type_name -> payload.v1.Update.Config
	36, // 32: payload.v1.Update.MultiRequest.requests:type_name -> payload.v1.Update.Request
	62, // 33: payload.v1.Update.ObjectRequest.object:type_name -> payload.v1.Object.Blob
	40, // 34: payload.v1.Update.ObjectRequest.config:type_name -> payload.v1.Update.Config
	24, // 35: payload.v1.Update.ObjectRequest.vectorizer:type_name -> payload.v1.Filter.Target
	38, // 36: payload.v1.Update.MultiObjectRequest.requests:type_name -> payload.v1.Update.ObjectRequest
	26, // 37: payload.v1.Update.Config.filters:type_name -> payload.v1.Filter.Config
	56, // 38: payload.v1.Upsert.Request.vector:type_name -> payload.v1.Object.Vector
	45, // 39: payload.v1.Upsert.Request.config:type_name -> payload.v1.Upsert.Config
	41, // 40: payload.v1.Upsert.MultiRequest.requests:type_name -> payload.v1.Upsert.Request
	62, // 41: payload.v1.Upsert.ObjectRequest.object:type_name -> payload.v1.Object.Blob
	45, // 42: payload.v1.Upsert.ObjectRequest.config:type_name -> payload.v1.Upsert.Config
	24, // 43: payload.v1.Upsert.ObjectRequest.vectorizer:type_name -> payload.v1.Filter.Target
	43, // 44: payload.v1.Upsert.MultiObjectRequest.requests:type_name -> payload.v1.Upsert.ObjectRequest
	26, // 45: payload.v1.Upsert.Config.filters:type_name -> payload.v1.Filter.Config
	54, // 46: payload.v1.Remove.Request.id:type_name -> payload.v1.Object.ID
	50, // 47: payload.v1.Remove.Request.config:type_name -> payload.v1.Remove.Config
	46, // 48: payload.v1.Remove.MultiRequest.requests:type_name -> payload.v1.Remove.Request
	49, // 49: payload.v1.Remove.TimestampRequest.timestamps:type_name -> payload.v1.Remove.Timestamp
	1,  // 50: payload.v1.Remove.Timestamp.operator:type_name -> payload.v1.Remove.Timestamp.Operator
	54, // 51: payload.v1.Object.VectorRequest.id:type_name -> payload.v1.Object.ID
	26, // 52: payload.v1.Object.VectorRequest.filters:type_name -> payload.v1.Filter.Config
	52, // 53: payload.v1.Object.StreamDistance.distance:type_name -> payload.v1.Object.Distance
	93, // 54: payload.v1.Object.StreamDistance.status:type_name -> google.rpc.Status
	54, // 55: payload.v1.Object.GetTimestampRequest.id:type_name -> payload.v1.Object.ID
	56, // 56: payload.v1.Object.Vectors.vectors:type_name -> payload.v1.Object.Vector
	56, // 57: payload.v1.Object.StreamVector.vector:type_name -> payload.v1.Object.Vector
	93, // 58: payload.v1.Object.StreamVector.status:type_name -> google.rpc.Status
	62, // 59: payload.v1.Object.StreamBlob.blob:type_name -> payload.v1.Object.Blob
	93, // 60: payload.v1.Object.StreamBlob.status:type_name -> google.rpc.Status
	64, // 61: payload.v1.Object.StreamLocation.location:type_name -> payload.v1.Object.Location
	93, // 62: payload.v1.Object.StreamLocation.status:type_name -> google.rpc.Status
	64, // 63: payload.v1.Object.Locations.locations:type_name -> payload.v1.Object.Location
	56, // 64: payload.v1.Object.List.Response.vector:type_name -> payload.v1.Object.Vector
	93, // 65: payload.v1.Object.List.Response.status:type_name -> google.rpc.Status
	79, // 66: payload.v1.Info.Pod.cpu:type_name -> payload.v1.Info.CPU
	80, // 67: payload.v1.Info.Pod.memory:type_name -> payload.v1.Info.Memory
	74, // 68: payload.v1.Info.Pod.node:type_name -> payload.v1.Info.Node
	79, // 69: payload.v1.Info.Node.cpu:type_name -> payload.v1.Info.CPU
	80, // 70: payload.v1.Info.Node.memory:type_name -> payload.v1.Info.Memory
	81, // 71: payload.v1.Info.Node.Pods:type_name -> payload.v1.Info.Pods
	76, // 72: payload.v1.Info.Service.ports:type_name -> payload.v1.Info.ServicePort
	77, // 73: payload.v1.Info.Service.labels:type_name -> payload.v1.Info.Labels
	78, // 74: payload.v1.Info.Service.annotations:type_name -> payload.v1.Info.Annotations
	89, // 75: payload.v1.Info.Labels.labels:type_name -> payload.v1.Info.Labels.LabelsEntry
	90, // 76: payload.v1.Info.Annotations.annotations:type_name -> payload.v1.Info.Annotations.AnnotationsEntry
	73, // 77: payload.v1.Info.Pods.pods:type_name -> payload.v1.Info.Pod
	74, // 78: payload.v1.Info.Nodes.nodes:type_name -> payload.v1.Info.Node
	75, // 79: payload.v1.Info.Services.services:type_name -> payload.v1.Info.Service
	91, // 80: payload.v1.Mirror.Targets.targets:type_name -> payload.v1.Mirror.Target
...
func file_v1_payload_payload_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_v1_payload_payload_proto_msgTypes[89].Exporter = func(v interface{}, i int) interface{} {
		...
		file_v1_payload_payload_proto_msgTypes[90].Exporter = func(v interface{}, i int) interface{} {
	...
	file_v1_payload_payload_proto_msgTypes[51].OneofWrappers = []interface{}{
	...
	file_v1_payload_payload_proto_msgTypes[63].OneofWrappers = []interface{}{
		(*Object_StreamLocation_Location)(nil),
		(*Object_StreamLocation_Status)(nil),
	}
	file_v1_payload_payload_proto_msgTypes[67].OneofWrappers = []interface{}{
