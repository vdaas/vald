...
func (c *updateClient) UpdateTimestamp(ctx context.Context, in *payload.Update_TimestampRequest, opts ...grpc.CallOption) (*payload.Object_Location, error) {
	out := new(payload.Object_Location)
...
func (UnimplementedUpdateServer) UpdateTimestamp(context.Context, *payload.Update_TimestampRequest) (*payload.Object_Location, error) {
