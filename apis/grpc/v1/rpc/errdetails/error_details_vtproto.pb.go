...
func (m *RetryInfo) CloneVT() *RetryInfo {
	...
	r := new(RetryInfo)
	r.RetryDelay = (*durationpb.Duration)((*durationpb1.Duration)(m.RetryDelay).CloneVT())
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
	}
...
func (m *DebugInfo) CloneVT() *DebugInfo {
	...
	r := new(DebugInfo)
	r.Detail = m.Detail
	if rhs := m.StackEntries; rhs != nil {
		tmpContainer := make([]string, len(rhs))
		copy(tmpContainer, rhs)
		r.StackEntries = tmpContainer
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (m *QuotaFailure_Violation) CloneVT() *QuotaFailure_Violation {
	if m == nil {
		return (*QuotaFailure_Violation)(nil)
	}
	r := new(QuotaFailure_Violation)
	r.Subject = m.Subject
...
func (m *QuotaFailure) CloneVT() *QuotaFailure {
	if m == nil {
		return (*QuotaFailure)(nil)
	}
	r := new(QuotaFailure)
	if rhs := m.Violations; rhs != nil {
		tmpContainer := make([]*QuotaFailure_Violation, len(rhs))
		for k, v := range rhs {
...
func (m *PreconditionFailure_Violation) CloneVT() *PreconditionFailure_Violation {
	if m == nil {
		return (*PreconditionFailure_Violation)(nil)
	}
	r := new(PreconditionFailure_Violation)
	r.Type = m.Type
	r.Subject = m.Subject
	r.Description = m.Description
	if len(m.unknownFields) > 0 {
...
func (m *PreconditionFailure) CloneVT() *PreconditionFailure {
	if m == nil {
		return (*PreconditionFailure)(nil)
	}
	r := new(PreconditionFailure)
	if rhs := m.Violations; rhs != nil {
		tmpContainer := make([]*PreconditionFailure_Violation, len(rhs))
		for k, v := range rhs {
			tmpContainer[k] = v.CloneVT()
		}
		r.Violations = tmpContainer
...
func (m *BadRequest_FieldViolation) CloneVT() *BadRequest_FieldViolation {
	if m == nil {
		return (*BadRequest_FieldViolation)(nil)
	}
	r := new(BadRequest_FieldViolation)
	r.Field = m.Field
	r.Description = m.Description
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
...
func (m *BadRequest) CloneVT() *BadRequest {
	...
	r := new(BadRequest)
	if rhs := m.FieldViolations; rhs != nil {
		tmpContainer := make([]*BadRequest_FieldViolation, len(rhs))
		for k, v := range rhs {
			tmpContainer[k] = v.CloneVT()
		}
		r.FieldViolations = tmpContainer
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (m *Help) CloneVT() *Help {
	...
	if rhs := m.Links; rhs != nil {
		tmpContainer := make([]*Help_Link, len(rhs))
		for k, v := range rhs {
			tmpContainer[k] = v.CloneVT()
		}
...
func (this *RetryInfo) EqualVT(that *RetryInfo) bool {
	...
	if !(*durationpb1.Duration)(this.RetryDelay).EqualVT((*durationpb1.Duration)(that.RetryDelay)) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (this *DebugInfo) EqualVT(that *DebugInfo) bool {
	...
	if len(this.StackEntries) != len(that.StackEntries) {
		return false
	}
	for i, vx := range this.StackEntries {
		vy := that.StackEntries[i]
		if vx != vy {
			return false
		}
	}
...
func (this *QuotaFailure_Violation) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*QuotaFailure_Violation)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (this *QuotaFailure) EqualVT(that *QuotaFailure) bool {
	...
	for i, vx := range this.Violations {
		...
		if p, q := vx, vy; p != q {
			if p == nil {
				p = &QuotaFailure_Violation{}
			}
			if q == nil {
				q = &QuotaFailure_Violation{}
			}
			if !p.EqualVT(q) {
				return false
			}
...
func (this *PreconditionFailure_Violation) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*PreconditionFailure_Violation)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (this *PreconditionFailure) EqualVT(that *PreconditionFailure) bool {
	...
	for i, vx := range this.Violations {
		...
		if p, q := vx, vy; p != q {
			if p == nil {
				p = &PreconditionFailure_Violation{}
			}
			if q == nil {
				q = &PreconditionFailure_Violation{}
			}
			if !p.EqualVT(q) {
				return false
			}
...
func (this *PreconditionFailure) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*PreconditionFailure)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (this *BadRequest_FieldViolation) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*BadRequest_FieldViolation)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (this *BadRequest) EqualVT(that *BadRequest) bool {
	...
	if len(this.FieldViolations) != len(that.FieldViolations) {
		return false
	}
	for i, vx := range this.FieldViolations {
		vy := that.FieldViolations[i]
		if p, q := vx, vy; p != q {
			if p == nil {
				p = &BadRequest_FieldViolation{}
			}
			if q == nil {
				q = &BadRequest_FieldViolation{}
			}
			if !p.EqualVT(q) {
				return false
			}
...
func (this *RequestInfo) EqualVT(that *RequestInfo) bool {
	...
	if this.ServingData != that.ServingData {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (this *LocalizedMessage) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*LocalizedMessage)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (m *RetryInfo) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.RetryDelay != nil {
		size, err := (*durationpb1.Duration)(m.RetryDelay).MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *DebugInfo) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.StackEntries) > 0 {
		for iNdEx := len(m.StackEntries) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.StackEntries[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *RequestInfo) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.ServingData) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.ServingData)))
		i--
		dAtA[i] = 0x12
	}
...
func (m *RetryInfo) MarshalVTStrict() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *RetryInfo) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *RetryInfo) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if m.RetryDelay != nil {
		size, err := (*durationpb1.Duration)(m.RetryDelay).MarshalToSizedBufferVTStrict(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *QuotaFailure_Violation) MarshalVTStrict() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *QuotaFailure_Violation) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *QuotaFailure_Violation) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *QuotaFailure) MarshalVTStrict() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *QuotaFailure) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *QuotaFailure) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *PreconditionFailure_Violation) MarshalVTStrict() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *PreconditionFailure_Violation) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *PreconditionFailure_Violation) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *BadRequest_FieldViolation) MarshalVTStrict() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *BadRequest_FieldViolation) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *BadRequest_FieldViolation) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *BadRequest) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if len(m.FieldViolations) > 0 {
		for iNdEx := len(m.FieldViolations) - 1; iNdEx >= 0; iNdEx-- {
			size, err := m.FieldViolations[iNdEx].MarshalToSizedBufferVTStrict(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *ResourceInfo) MarshalVTStrict() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *ResourceInfo) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *ResourceInfo) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *Help_Link) MarshalVTStrict() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *Help_Link) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *Help_Link) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *Help) MarshalVTStrict() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *Help) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *Help) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *RetryInfo) SizeVT() (n int) {
	...
	_ = l
	if m.RetryDelay != nil {
		l = (*durationpb1.Duration)(m.RetryDelay).SizeVT()
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	}
	n += len(m.unknownFields)
	return n
...
func (m *RetryInfo) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if err := (*durationpb1.Duration)(m.RetryDelay).UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *QuotaFailure_Violation) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QuotaFailure_Violation: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QuotaFailure_Violation: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *PreconditionFailure_Violation) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PreconditionFailure_Violation: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PreconditionFailure_Violation: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *Help_Link) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: Help_Link: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: Help_Link: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *RetryInfo) UnmarshalVTUnsafe(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if err := (*durationpb1.Duration)(m.RetryDelay).UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *DebugInfo) UnmarshalVTUnsafe(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.StackEntries = append(m.StackEntries, stringValue)
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Detail", wireType)
...
func (m *BadRequest) UnmarshalVTUnsafe(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.FieldViolations = append(m.FieldViolations, &BadRequest_FieldViolation{})
			if err := m.FieldViolations[len(m.FieldViolations)-1].UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
