...
const file_v1_rpc_errdetails_error_details_proto_rawDesc = "" +
	"\n" +
	"%v1/rpc/errdetails/error_details.proto\x12\x06rpc.v1\x1a\x1egoogle/protobuf/duration.proto\"\xb5\x01\n" +
	"\tErrorInfo\x12\x16\n" +
	"\x06reason\x18\x01 \x01(\tR\x06reason\x12\x16\n" +
	"\x06domain\x18\x02 \x01(\tR\x06domain\x12;\n" +
	"\bmetadata\x18\x03 \x03(\v2\x1f.rpc.v1.ErrorInfo.MetadataEntryR\bmetadata\x1a;\n" +
	...
	"\x06detail\x18\x02 \x01(\tR\x06detail\"\x97\x01\n" +
	"\fQuotaFailure\x12>\n" +
	"\n" +
	"violations\x18\x01 \x03(\v2\x1e.rpc.v1.QuotaFailure.ViolationR\n" +
	"violations\x1aG\n" +
	"\tViolation\x12\x18\n" +
	"\asubject\x18\x01 \x01(\tR\asubject\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\"\xb9\x01\n" +
	"\x13PreconditionFailure\x12E\n" +
	"\n" +
	"violations\x18\x01 \x03(\v2%.rpc.v1.PreconditionFailure.ViolationR\n" +
	"violations\x1a[\n" +
	"\tViolation\x12\x12\n" +
	...
	"\n" +
	"BadRequest\x12L\n" +
	"\x10field_violations\x18\x01 \x03(\v2!.rpc.v1.BadRequest.FieldViolationR\x0ffieldViolations\x1aH\n" +
	...
	"\x04Help\x12'\n" +
	"\x05links\x18\x01 \x03(\v2\x11.rpc.v1.Help.LinkR\x05links\x1a:\n" +
	"\x04Link\x12 \n" +
	...
	"\amessage\x18\x02 \x01(\tR\amessageBi\n" +
	"\x19org.vdaas.vald.api.v1.rpcB\x11ErrorDetailsProtoP\x01Z1github.com/vdaas/vald/apis/grpc/v1/rpc/errdetails\xa2\x02\x03RPCb\x06proto3"
...
func file_v1_rpc_errdetails_error_details_proto_rawDescGZIP() []byte {
	file_v1_rpc_errdetails_error_details_proto_rawDescOnce.Do(func() {
		file_v1_rpc_errdetails_error_details_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_v1_rpc_errdetails_error_details_proto_rawDesc), len(file_v1_rpc_errdetails_error_details_proto_rawDesc)))
	})
