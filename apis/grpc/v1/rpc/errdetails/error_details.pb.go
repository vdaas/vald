...
var file_v1_rpc_errdetails_error_details_proto_rawDesc = string([]byte{
...
var (
	...
	file_v1_rpc_errdetails_error_details_proto_rawDescData []byte
)
...
func file_v1_rpc_errdetails_error_details_proto_rawDescGZIP() []byte {
	file_v1_rpc_errdetails_error_details_proto_rawDescOnce.Do(func() {
		file_v1_rpc_errdetails_error_details_proto_rawDescData = protoimpl.X.CompressGZIP(
			unsafe.Slice(unsafe.StringData(file_v1_rpc_errdetails_error_details_proto_rawDesc), len(file_v1_rpc_errdetails_error_details_proto_rawDesc)),
		)
	})
...
func file_v1_rpc_errdetails_error_details_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_v1_rpc_errdetails_error_details_proto_rawDesc), len(file_v1_rpc_errdetails_error_details_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   15,
			NumExtensions: 0,
			NumServices:   0,
