...
func (m *Store) CloneVT() *Store {
	...
	r.State = m.State
	r.Version = m.Version
	r.PeerAddress = m.PeerAddress
	r.StatusAddress = m.StatusAddress
	r.GitHash = m.GitHash
	r.StartTimestamp = m.StartTimestamp
	r.DeployPath = m.DeployPath
	r.LastHeartbeat = m.LastHeartbeat
	r.PhysicallyDestroyed = m.PhysicallyDestroyed
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
	}
...
func (m *Store) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (m *RegionEpoch) CloneVT() *RegionEpoch {
	if m == nil {
		return (*RegionEpoch)(nil)
	}
	r := new(RegionEpoch)
	r.ConfVer = m.ConfVer
	r.Version = m.Version
...
func (m *RegionEpoch) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (this *Store) EqualVT(that *Store) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
	...
	if this.PeerAddress != that.PeerAddress {
		return false
	}
	if this.StatusAddress != that.StatusAddress {
		return false
	}
	if this.GitHash != that.GitHash {
		return false
	}
	if this.StartTimestamp != that.StartTimestamp {
		return false
	}
	if this.DeployPath != that.DeployPath {
		return false
	}
	if this.LastHeartbeat != that.LastHeartbeat {
		return false
	}
	if this.PhysicallyDestroyed != that.PhysicallyDestroyed {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}

func (this *Store) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*Store)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (this *Region2) EqualVT(that *Region2) bool {
	...
	if this.IsInFlashback != that.IsInFlashback {
		return false
	}
...
func (this *RegionEpoch) EqualVT(that *RegionEpoch) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
	}
	if this.ConfVer != that.ConfVer {
		return false
	}
	if this.Version != that.Version {
		return false
...
func (this *RegionEpoch) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*RegionEpoch)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (m *Store) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.LastHeartbeat != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.LastHeartbeat))
		i--
		dAtA[i] = 0x58
	}
	if len(m.DeployPath) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.DeployPath)))
		i--
		dAtA[i] = 0x52
	}
	...
	if len(m.GitHash) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.GitHash)))
		i--
		dAtA[i] = 0x42
	}
	if len(m.StatusAddress) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.StatusAddress)))
		i--
		dAtA[i] = 0x3a
	}
...
func (m *RegionEpoch) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *RegionEpoch) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *RegionEpoch) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if m.ConfVer != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.ConfVer))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Peer) MarshalVTStrict() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *Peer) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *Peer) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *Store) MarshalVTStrict() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *Store) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *Store) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *RegionEpoch) MarshalVTStrict() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *RegionEpoch) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *RegionEpoch) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *Store) SizeVT() (n int) {
	...
	if m.LastHeartbeat != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.LastHeartbeat))
	}
	if m.PhysicallyDestroyed {
		n += 2
	}
...
func (m *RegionEpoch) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.ConfVer != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.ConfVer))
	}
	if m.Version != 0 {
...
func (m *RegionEpoch) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *Peer) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *Store) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *RegionEpoch) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
