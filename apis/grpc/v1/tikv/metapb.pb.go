...
func (x *Region2) GetRegionEpoch() *RegionEpoch {
	if x != nil {
...
func (x *RegionEpoch) Reset() {
	*x = RegionEpoch{}
	mi := &file_v1_tikv_metapb_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RegionEpoch) Descriptor() ([]byte, []int) {
	return file_v1_tikv_metapb_proto_rawDescGZIP(), []int{3}
}
...
const file_v1_tikv_metapb_proto_rawDesc = "" +
	...
	"\x14physically_destroyed\x18\f \x01(\bR\x13physicallyDestroyed\"\x81\x02\n" +
	"\aRegion2\x12\x0e\n" +
	...
	"\x12flashback_start_ts\x18\b \x01(\x04R\x10flashbackStartTs\"B\n" +
	"\vRegionEpoch\x12\x19\n" +
	"\bconf_ver\x18\x01 \x01(\x04R\aconfVer\x12\x18\n" +
	"\aversion\x18\x02 \x01(\x04R\aversion*0\n" +
	"\n" +
	"StoreState\x12\x06\n" +
	"\x02Up\x10\x00\x12\v\n" +
...
var (
	...
	file_v1_tikv_metapb_proto_msgTypes  = make([]protoimpl.MessageInfo, 4)
...
var file_v1_tikv_metapb_proto_depIdxs = []int32{
	...
	1, // 2: metapb.Region2.peers:type_name -> metapb.Peer
