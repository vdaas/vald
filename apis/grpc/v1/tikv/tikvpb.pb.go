...
const file_v1_tikv_tikvpb_proto_rawDesc = "" +
	"\n" +
	"\x14v1/tikv/tikvpb.proto\x12\x06tikvpb\x1a\x15v1/tikv/kvrpcpb.proto2\x8f\x03\n" +
	"\x04Tikv\x125\n" +
...
var file_v1_tikv_tikvpb_proto_depIdxs = []int32{
	...
	2,  // 2: tikvpb.Tikv.RawPut:input_type -> tikv.RawPutRequest
	3,  // 3: tikvpb.Tikv.RawBatchPut:input_type -> tikv.RawBatchPutRequest
	4,  // 4: tikvpb.Tikv.RawDelete:input_type -> tikv.RawDeleteRequest
	5,  // 5: tikvpb.Tikv.RawBatchDelete:input_type -> tikv.RawBatchDeleteRequest
	6,  // 6: tikvpb.Tikv.RawGet:output_type -> tikv.RawGetResponse
	7,  // 7: tikvpb.Tikv.RawBatchGet:output_type -> tikv.RawBatchGetResponse
	8,  // 8: tikvpb.Tikv.RawPut:output_type -> tikv.RawPutResponse
	9,  // 9: tikvpb.Tikv.RawBatchPut:output_type -> tikv.RawBatchPutResponse
	10, // 10: tikvpb.Tikv.RawDelete:output_type -> tikv.RawDeleteResponse
	11, // 11: tikvpb.Tikv.RawBatchDelete:output_type -> tikv.RawBatchDeleteResponse
