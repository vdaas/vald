...
var file_v1_tikv_errorpb_proto_depIdxs = []int32{
	...
	0,  // 1: tikv.Error.not_leader:type_name -> tikv.NotLeader
	5,  // 2: tikv.Error.region_not_found:type_name -> tikv.RegionNotFound
	7,  // 3: tikv.Error.key_not_in_region:type_name -> tikv.KeyNotInRegion
	8,  // 4: tikv.Error.epoch_not_match:type_name -> tikv.EpochNotMatch
	9,  // 5: tikv.Error.server_is_busy:type_name -> tikv.ServerIsBusy
	10, // 6: tikv.Error.stale_command:type_name -> tikv.StaleCommand
	4,  // 7: tikv.Error.store_not_match:type_name -> tikv.StoreNotMatch
	11, // 8: tikv.Error.raft_entry_too_large:type_name -> tikv.RaftEntryTooLarge
	12, // 9: tikv.Error.max_timestamp_not_synced:type_name -> tikv.MaxTimestampNotSynced
	13, // 10: tikv.Error.read_index_not_ready:type_name -> tikv.ReadIndexNotReady
	14, // 11: tikv.Error.proposal_in_merging_mode:type_name -> tikv.ProposalInMergingMode
	15, // 12: tikv.Error.data_is_not_ready:type_name -> tikv.DataIsNotReady
	6,  // 13: tikv.Error.region_not_initialized:type_name -> tikv.RegionNotInitialized
	3,  // 14: tikv.Error.disk_full:type_name -> tikv.DiskFull
	16, // 15: tikv.Error.RecoveryInProgress:type_name -> tikv.RecoveryInProgress
	17, // 16: tikv.Error.FlashbackInProgress:type_name -> tikv.FlashbackInProgress
	18, // 17: tikv.Error.FlashbackNotPrepared:type_name -> tikv.FlashbackNotPrepared
	1,  // 18: tikv.Error.is_witness:type_name -> tikv.IsWitness
	19, // 19: tikv.Error.mismatch_peer_id:type_name -> tikv.MismatchPeerId
	2,  // 20: tikv.Error.bucket_version_not_match:type_name -> tikv.BucketVersionNotMatch
	20, // 21: tikv.Error.undetermined_result:type_name -> tikv.UndeterminedResult
