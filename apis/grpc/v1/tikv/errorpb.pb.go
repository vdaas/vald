...
const file_v1_tikv_errorpb_proto_rawDesc = "" +
	"\n" +
	"\x15v1/tikv/errorpb.proto\x12\akvrpcpb\"(\n" +
	"\tNotLeader\x12\x1b\n" +
	...
	"\amessage\x18\x01 \x01(\tR\amessage\"\x83\f\n" +
	"\x05Error\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage\x121\n" +
	"\n" +
	"not_leader\x18\x02 \x01(\v2\x12.kvrpcpb.NotLeaderR\tnotLeader\x12A\n" +
	"\x10region_not_found\x18\x03 \x01(\v2\x17.kvrpcpb.RegionNotFoundR\x0eregionNotFound\x12B\n" +
	"\x11key_not_in_region\x18\x04 \x01(\v2\x17.kvrpcpb.KeyNotInRegionR\x0ekeyNotInRegion\x12>\n" +
	"\x0fepoch_not_match\x18\x05 \x01(\v2\x16.kvrpcpb.EpochNotMatchR\repochNotMatch\x12;\n" +
	"\x0eserver_is_busy\x18\x06 \x01(\v2\x15.kvrpcpb.ServerIsBusyR\fserverIsBusy\x12:\n" +
	"\rstale_command\x18\a \x01(\v2\x15.kvrpcpb.StaleCommandR\fstaleCommand\x12>\n" +
	"\x0fstore_not_match\x18\b \x01(\v2\x16.kvrpcpb.StoreNotMatchR\rstoreNotMatch\x12K\n" +
	"\x14raft_entry_too_large\x18\t \x01(\v2\x1a.kvrpcpb.RaftEntryTooLargeR\x11raftEntryTooLarge\x12W\n" +
	"\x18max_timestamp_not_synced\x18\n" +
	" \x01(\v2\x1e.kvrpcpb.MaxTimestampNotSyncedR\x15maxTimestampNotSynced\x12K\n" +
	"\x14read_index_not_ready\x18\v \x01(\v2\x1a.kvrpcpb.ReadIndexNotReadyR\x11readIndexNotReady\x12W\n" +
	"\x18proposal_in_merging_mode\x18\f \x01(\v2\x1e.kvrpcpb.ProposalInMergingModeR\x15proposalInMergingMode\x12B\n" +
	"\x11data_is_not_ready\x18\r \x01(\v2\x17.kvrpcpb.DataIsNotReadyR\x0edataIsNotReady\x12S\n" +
	"\x16region_not_initialized\x18\x0e \x01(\v2\x1d.kvrpcpb.RegionNotInitializedR\x14regionNotInitialized\x12.\n" +
	"\tdisk_full\x18\x0f \x01(\v2\x11.kvrpcpb.DiskFullR\bdiskFull\x12K\n" +
	"\x12RecoveryInProgress\x18\x10 \x01(\v2\x1b.kvrpcpb.RecoveryInProgressR\x12RecoveryInProgress\x12N\n" +
	"\x13FlashbackInProgress\x18\x11 \x01(\v2\x1c.kvrpcpb.FlashbackInProgressR\x13FlashbackInProgress\x12Q\n" +
	"\x14FlashbackNotPrepared\x18\x12 \x01(\v2\x1d.kvrpcpb.FlashbackNotPreparedR\x14FlashbackNotPrepared\x121\n" +
	"\n" +
	"is_witness\x18\x13 \x01(\v2\x12.kvrpcpb.IsWitnessR\tisWitness\x12A\n" +
	"\x10mismatch_peer_id\x18\x14 \x01(\v2\x17.kvrpcpb.MismatchPeerIdR\x0emismatchPeerId\x12W\n" +
	"\x18bucket_version_not_match\x18\x15 \x01(\v2\x1e.kvrpcpb.BucketVersionNotMatchR\x15bucketVersionNotMatch\x12L\n" +
	"\x13undetermined_result\x18\x16 \x01(\v2\x1b.kvrpcpb.UndeterminedResultR\x12undeterminedResultR\vstale_epochB)Z'github.com/vdaas/vald/apis/grpc/v1/tikvb\x06proto3"
...
var (
	...
	file_v1_tikv_errorpb_proto_goTypes  = []any{
		(*NotLeader)(nil),             // 0: kvrpcpb.NotLeader
		(*IsWitness)(nil),             // 1: kvrpcpb.IsWitness
		(*BucketVersionNotMatch)(nil), // 2: kvrpcpb.BucketVersionNotMatch
		(*DiskFull)(nil),              // 3: kvrpcpb.DiskFull
		(*StoreNotMatch)(nil),         // 4: kvrpcpb.StoreNotMatch
		(*RegionNotFound)(nil),        // 5: kvrpcpb.RegionNotFound
		(*RegionNotInitialized)(nil),  // 6: kvrpcpb.RegionNotInitialized
		(*KeyNotInRegion)(nil),        // 7: kvrpcpb.KeyNotInRegion
		(*EpochNotMatch)(nil),         // 8: kvrpcpb.EpochNotMatch
		(*ServerIsBusy)(nil),          // 9: kvrpcpb.ServerIsBusy
		(*StaleCommand)(nil),          // 10: kvrpcpb.StaleCommand
		(*RaftEntryTooLarge)(nil),     // 11: kvrpcpb.RaftEntryTooLarge
		(*MaxTimestampNotSynced)(nil), // 12: kvrpcpb.MaxTimestampNotSynced
		(*ReadIndexNotReady)(nil),     // 13: kvrpcpb.ReadIndexNotReady
		(*ProposalInMergingMode)(nil), // 14: kvrpcpb.ProposalInMergingMode
		(*DataIsNotReady)(nil),        // 15: kvrpcpb.DataIsNotReady
		(*RecoveryInProgress)(nil),    // 16: kvrpcpb.RecoveryInProgress
		(*FlashbackInProgress)(nil),   // 17: kvrpcpb.FlashbackInProgress
		(*FlashbackNotPrepared)(nil),  // 18: kvrpcpb.FlashbackNotPrepared
		(*MismatchPeerId)(nil),        // 19: kvrpcpb.MismatchPeerId
		(*UndeterminedResult)(nil),    // 20: kvrpcpb.UndeterminedResult
...
var file_v1_tikv_errorpb_proto_depIdxs = []int32{
	...
	7,  // 2: kvrpcpb.Error.key_not_in_region:type_name -> kvrpcpb.KeyNotInRegion
	8,  // 3: kvrpcpb.Error.epoch_not_match:type_name -> kvrpcpb.EpochNotMatch
	9,  // 4: kvrpcpb.Error.server_is_busy:type_name -> kvrpcpb.ServerIsBusy
	10, // 5: kvrpcpb.Error.stale_command:type_name -> kvrpcpb.StaleCommand
	4,  // 6: kvrpcpb.Error.store_not_match:type_name -> kvrpcpb.StoreNotMatch
	11, // 7: kvrpcpb.Error.raft_entry_too_large:type_name -> kvrpcpb.RaftEntryTooLarge
	12, // 8: kvrpcpb.Error.max_timestamp_not_synced:type_name -> kvrpcpb.MaxTimestampNotSynced
	13, // 9: kvrpcpb.Error.read_index_not_ready:type_name -> kvrpcpb.ReadIndexNotReady
	14, // 10: kvrpcpb.Error.proposal_in_merging_mode:type_name -> kvrpcpb.ProposalInMergingMode
	15, // 11: kvrpcpb.Error.data_is_not_ready:type_name -> kvrpcpb.DataIsNotReady
	6,  // 12: kvrpcpb.Error.region_not_initialized:type_name -> kvrpcpb.RegionNotInitialized
	3,  // 13: kvrpcpb.Error.disk_full:type_name -> kvrpcpb.DiskFull
	16, // 14: kvrpcpb.Error.RecoveryInProgress:type_name -> kvrpcpb.RecoveryInProgress
	17, // 15: kvrpcpb.Error.FlashbackInProgress:type_name -> kvrpcpb.FlashbackInProgress
	18, // 16: kvrpcpb.Error.FlashbackNotPrepared:type_name -> kvrpcpb.FlashbackNotPrepared
	1,  // 17: kvrpcpb.Error.is_witness:type_name -> kvrpcpb.IsWitness
	19, // 18: kvrpcpb.Error.mismatch_peer_id:type_name -> kvrpcpb.MismatchPeerId
	2,  // 19: kvrpcpb.Error.bucket_version_not_match:type_name -> kvrpcpb.BucketVersionNotMatch
	20, // 20: kvrpcpb.Error.undetermined_result:type_name -> kvrpcpb.UndeterminedResult
