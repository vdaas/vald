...
public:
    ...
    void set_qbg_build_parameters(
        ...
        bool,
        bool);
    void set_hierarchical_clustering_init_mode(rust::i16);
    void set_number_of_first_objects(rust::usize);
    void set_number_of_first_clusters(rust::usize);
    void set_number_of_second_objects(rust::u32);
...
public:
    ...
    void search(rust::Slice<const rust::f32>, rust::usize, rust::i32 *, rust::f32 *);
};
