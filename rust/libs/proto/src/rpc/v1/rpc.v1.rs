...
pub mod quota_failure {
    ...
    impl ::prost::Name for Violation {
        ...
        const PACKAGE: &'static str = "rpc.v1";
        fn full_name() -> ::prost::alloc::string::String {
            "rpc.v1.QuotaFailure.Violation".into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/rpc.v1.QuotaFailure.Violation".into()
        }
...
pub mod precondition_failure {
    ...
    impl ::prost::Name for Violation {
        ...
        const PACKAGE: &'static str = "rpc.v1";
        fn full_name() -> ::prost::alloc::string::String {
            "rpc.v1.PreconditionFailure.Violation".into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/rpc.v1.PreconditionFailure.Violation".into()
        }
...
impl ::prost::Name for PreconditionFailure {
    ...
    const PACKAGE: &'static str = "rpc.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "rpc.v1.PreconditionFailure".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/rpc.v1.PreconditionFailure".into()
    }
...
pub mod bad_request {
    ...
    impl ::prost::Name for FieldViolation {
        ...
        const PACKAGE: &'static str = "rpc.v1";
        fn full_name() -> ::prost::alloc::string::String {
            "rpc.v1.BadRequest.FieldViolation".into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/rpc.v1.BadRequest.FieldViolation".into()
        }
