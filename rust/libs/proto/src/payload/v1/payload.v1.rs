...
const PACKAGE: &'static str = "payload.v1";
fn full_name() -> ::prost::alloc::string::String { "payload.v1.Info.Stats.ResourceStats".into() }fn type_url() -> ::prost::alloc::string::String { "/payload.v1.Info.Stats.ResourceStats".into() }}
...
const PACKAGE: &'static str = "payload.v1";
fn full_name() -> ::prost::alloc::string::String { "payload.v1.Info.Stats.ResourceStatsDetail".into() }fn type_url() -> ::prost::alloc::string::String { "/payload.v1.Info.Stats.ResourceStatsDetail".into() }}
...
const PACKAGE: &'static str = "payload.v1";
fn full_name() -> ::prost::alloc::string::String { "payload.v1.Info.Stats.CgroupStats".into() }fn type_url() -> ::prost::alloc::string::String { "/payload.v1.Info.Stats.CgroupStats".into() }}
    }
impl ::prost::Name for Stats {
const NAME: &'static str = "Stats";
const PACKAGE: &'static str = "payload.v1";
fn full_name() -> ::prost::alloc::string::String { "payload.v1.Info.Stats".into() }fn type_url() -> ::prost::alloc::string::String { "/payload.v1.Info.Stats".into() }}
    #[derive(Clone, Copy, PartialEq, ::prost::Message)]
    pub struct CgroupStats {
        /// CPU cores available
        #[prost(double, tag="1")]
