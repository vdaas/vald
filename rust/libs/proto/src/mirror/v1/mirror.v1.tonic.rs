...
pub mod mirror_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn register(
            &mut self,
            request: impl tonic::IntoRequest<super::super::super::payload::v1::mirror::Targets>,
        ) -> std::result::Result<
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static("/mirror.v1.Mirror/Register");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("mirror.v1.Mirror", "Register"));
...
pub mod mirror_server {
    ...
    #[async_trait]
    pub trait Mirror: std::marker::Send + std::marker::Sync + 'static {
        async fn register(
            &self,
                ...
                "/mirror.v1.Mirror/Register" => {
                        ...
                        > for RegisterSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let fut = async move { <T as Mirror>::register(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T> Clone for MirrorServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "mirror.v1.Mirror";
    impl<T> tonic::server::NamedService for MirrorServer<T> {
