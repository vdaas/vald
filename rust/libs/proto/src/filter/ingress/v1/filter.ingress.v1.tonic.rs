...
pub mod filter_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static("/filter.ingress.v1.Filter/GenVector");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("filter.ingress.v1.Filter", "GenVector"));
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/filter.ingress.v1.Filter/FilterVector");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("filter.ingress.v1.Filter", "FilterVector"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod filter_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/filter.ingress.v1.Filter/GenVector" => {
                    ...
                    struct GenVectorSvc<T: Filter>(pub Arc<T>);
                    impl<T: Filter>
                        tonic::server::UnaryService<
                            super::super::super::super::payload::v1::object::Blob,
                        > for GenVectorSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let fut =
                                async move { <T as Filter>::gen_vector(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
                ...
                "/filter.ingress.v1.Filter/FilterVector" => {
                        ...
                        > for FilterVectorSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut =
                                async move { <T as Filter>::filter_vector(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
                    let accept_compression_encodings = self.accept_compression_encodings;
    ...
    pub const SERVICE_NAME: &str = "filter.ingress.v1.Filter";
